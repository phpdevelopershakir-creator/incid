...
use PDF;
global $q33_type;
$q33_type=array('1'=>'Internal Trafficking', '2'=>'International Trafficking'); 
class Pichart33Controller extends Controller
{
      ...
      public static function getting_awarness_data ($participant=false){
        global $q33_type;
        $awarness_data =ThirtyThree::awarness_activities_q33_query_data();
        $q33_trafficking_men =0;
        $q33_trafficking_women =0;
        $q33_trafficking_third_gender =0;
        $total_adult=0;
        $total_children=0;
        $q33_trafficking_boy =0;
        $q33_trafficking_girl =0;
        $total_perticipant=0;
        $awarness_category_data=[];
        if($participant){ 
          foreach ($awarness_data as $row) {
            $total_adult_by_category=$row->q33_trafficking_men+$row->q33_trafficking_women+$row->q33_trafficking_third_gender;
            $total_children_by_category=$row->q33_trafficking_boy+$row->q33_trafficking_girl;
      ...
      $gtotal_people=0;
        foreach ($awarness_data as $row) {
            $category=[];
            $q33_trafficking_men+=$row->q33_trafficking_men;
            $q33_trafficking_women+=$row->q33_trafficking_women;
            $q33_trafficking_third_gender+=$row->q33_trafficking_third_gender;
            $q33_trafficking_boy+=$row->q33_trafficking_boy;
            $q33_trafficking_girl+=$row->q33_trafficking_girl;         
            $total_adult_by_category=$row->q33_trafficking_men+$row->q33_trafficking_women+$row->q33_trafficking_third_gender;
            ...
            $men_perchantege=helper::percentage_calculation($row->q33_trafficking_men, $participant ? $total_perticipant : $total_people);
            $women_perchantege=helper::percentage_calculation($row->q33_trafficking_women,$participant ? $total_perticipant :$total_people);
            $thirdg_perchantege=helper::percentage_calculation($row->q33_trafficking_third_gender,$participant ? $total_perticipant : $total_people);
            $boys_perchantege=helper::percentage_calculation($row->q33_trafficking_boy,$participant ? $total_perticipant : $total_people);
            $girls_perchantege=helper::percentage_calculation($row->q33_trafficking_girl,$participant ? $total_perticipant : $total_people);
            ...
            $category=array(
              'q33_type'=>helper::arraykeys_to_value($q33_type,$row->q33_type),
              'q33_trafficking_men'=> $row->q33_trafficking_men, 
              ...
              'total_third_gender'=> $q33_trafficking_third_gender, 
        ...
        if(count($awarness_category_data)>0){
            $total_category=array(
              'q33_type'=>'Total',
              'q33_trafficking_men'=> $q33_trafficking_men, 
              'men_perchantege'=> helper::percentage_calculation($q33_trafficking_men,$gtotal_people),   
              'q33_trafficking_women'=>$q33_trafficking_women, 
              'women_perchantege'=> helper::percentage_calculation($q33_trafficking_women,$gtotal_people), 
              'q33_trafficking_third_gender'=> $q33_trafficking_third_gender, 
              'thirdg_perchantege'=>helper::percentage_calculation($q33_trafficking_third_gender,$gtotal_people),
              'total_third_gender'=> $q33_trafficking_third_gender, 
              'percentage_third_gender'=>helper::percentage_calculation($q33_trafficking_third_gender,$gtotal_people),
              'q33_trafficking_boy' => $q33_trafficking_boy,
              'boys_perchantege'=>helper::percentage_calculation($q33_trafficking_boy,$gtotal_people),
              'q33_trafficking_girl' => $q33_trafficking_girl,
              'girls_perchantege'=>helper::percentage_calculation($q33_trafficking_girl,$gtotal_people),
    ...
    public function htmlRows ($data_array) {
        ...
        if(isset( $data_array) && !empty( $data_array)){
            foreach($data_array as $row){
              $row ='<tr>'
              .'<td id="q33_type" class="blank-cell row_cell">'.$row['q33_type'].'</td>'
              .'<td id="q33_trafficking_men" class="blank-cell row_cell">'.$row['q33_trafficking_men'].'</td>'
              .'<td id="men_perchantege" class="blank-cell row_cell">'.$row['men_perchantege'].'</td>'   
              .'<td id="q33_trafficking_women" class="blank-cell row_cell">'.$row['q33_trafficking_women'].'</td>'
              .'<td id="women_perchantege" class="blank-cell row_cell">'.$row['women_perchantege'].'</td>'
              .'<td id="q33_trafficking_third_gender" class="blank-cell row_cell">'.$row['q33_trafficking_third_gender'].'</td>'
              ...
              .'<td id="q33_trafficking_boy" class="blank-cell row_cell">'.$row['q33_trafficking_boy'].'</td>'
              .'<td id="boys_perchantege" class="blank-cell row_cell">'.$row['boys_perchantege'].'</td>'
              .'<td id="q33_trafficking_girl" class="blank-cell row_cell">'.$row['q33_trafficking_girl'].'</td>'
    ...
    public function participants33()
    {
    ...
    public function q33_generate_pdf()
    {
      ...
      $pdf=PDF::loadView('superadmin.case.q33_table_chart',compact('table1_rows','table2_rows')); // test using image for ''data''
      $pdf->setOptions(['dpi' => 150, 'defaultFont' => 'sans-serif','isJavascriptEnabled'=>true]);
      // $pdf->setOption('enable-javascript', true);
      // $pdf->setOption('javascript-delay', 5000);
      // $pdf->setOption('enable-smart-shrinking', true);
      // $pdf->setOption('no-stop-slow-scripts', true);
      return $pdf->stream('q33_chart.pdf');
    }
}
