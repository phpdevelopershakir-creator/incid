...
class ReportController extends Controller
{
    public function Reports()
    {
        ...
        return view('superadmin.report.reports', compact('users'));
    }
    public function searchByDateRange(Request $request)
    {
        ...
        // $questionsThree = Three::whereBetween('created_at', [$startDate, $endDate])->get();
        // $questionsFour = Four::whereBetween('created_at', [$startDate, $endDate])->get();
        // $questionsFive = Five::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsSix = Six::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsSeven = Seven::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsEight = Eight::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsNine = Nine::whereBetween('created_at', [$startDate, $endDate])->get();
        ...
        $questionsFourteen = Fourteen::whereBetween('created_at', [$startDate, $endDate])->get();
        ...
        $questionsEighteen = Eighteen::whereBetween('created_at', [$startDate, $endDate])->get();
        ...
        $questionsTwentyOne = TwentyOne::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsTwentyTwo = TwentyTwo::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsTwentyThree = TwentyThree::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsTwentyFour = TwentyFour::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsTwentyFive = TwentyFive::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsTwentySix = TwentySix::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsTwentySeven = TwentySeven::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsTwentyEight = TwentyEight::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsTwentyNine = TwentyNine::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsThirty = Thirty::whereBetween('created_at', [$startDate, $endDate])->get();


        $questionsThiryOne = ThiryOne::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsThirtyTwo = ThirtyTwo::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsThirtyThree = ThirtyThree::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsThirtyFour = ThirtyFour::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsThirtyFive = ThirtyFive::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsThirtySix = ThirtySix::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsThirtySeven = ThirtySeven::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsThirtyEight = ThirtyEight::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsThirtyNine = ThirtyNine::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFourty = Fourty::whereBetween('created_at', [$startDate, $endDate])->get();

        $questionsFortyOne = FortyOne::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFortyTwo = FortyTwo::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFortyThree = FortyThree::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFortyFour = FortyFour::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFortyFive = FortyFive::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFortySix = FortySix::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFortySeven = FortySeven::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFortyEight = FortyEight::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFortyNine = FortyNine::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFifty = Fifty::whereBetween('created_at', [$startDate, $endDate])->get();

        $questionsFiftyOne = FiftyOne::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFiftyTwo = FiftyTwo::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFiftyThree = FiftyThree::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFiftyFour = FiftyFour::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFiftyFive = FiftyFive::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFiftySix = FiftySix::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFiftySeven = FiftySeven::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFiftyEight = FiftyEight::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsFiftyNine = FiftyNine::whereBetween('created_at', [$startDate, $endDate])->get();
        $questionsSixty = Sixty::whereBetween('created_at', [$startDate, $endDate])->get();
        //return response()->json($questionsOne,$questionsTwo);
     
        return view('superadmin.report.report_view', compact(
            'questionOneData',
            'question_two_data',
            'questionsThree',
            'questionsFour',
    ...
    public function PdfDateRange(Request $request)
    {
        ...
        //     $questionsOne = One::whereBetween('created_at', [$startDate, $endDate])->get();
        //     $questionsTwo = Two::whereBetween('created_at', [$startDate, $endDate])->get();
        //     $questionsThree = Three::whereBetween('created_at', [$startDate, $endDate])->get();
        //     $questionsFour = Four::whereBetween('created_at', [$startDate, $endDate])->get();
        //     $questionsFive = Five::whereBetween('created_at', [$startDate, $endDate])->get();
        //     $questionsSix = Six::whereBetween('created_at', [$startDate, $endDate])->get();
        ...
        //     $pdf=PDF::loadView('superadmin.report.report_pdf',compact('questionsOne','questionsTwo','questionsThree',
        //     'questionsFour','questionsFive','questionsSix','questionsSeven','questionsEight','questionsNine',
        // 'questionsTen','questionsEleven','questionsTwelve','questionsThirteen','questionsFourteen','questionsFifteen',
        // 'questionsSixteen','questionsSeventeen','questionsEighteen','questionsNineteen','questionsTwenty','questionsTwentyOne','questionsTwentyTwo',
        // 'questionsTwentyThree','questionsTwentyFour','questionsTwentyFive','questionsTwentySix','questionsTwentySeven',
        // 'questionsTwentyEight','questionsTwentyNine','questionsThirty','questionsThiryOne','questionsThirtyTwo',
        // 'questionsThirtyThree','questionsThirtyFour','questionsThirtyFive','questionsThirtySix','questionsThirtySeven',
        // 'questionsThirtyEight','questionsThirtyNine','questionsFourty','questionsFortyOne','questionsFortyTwo','questionsFortyThree',
        // 'questionsFortyFour','questionsFortyFive','questionsFortySix','questionsFortySeven','questionsFortyEight','questionsFortyNine',
        // 'questionsFifty','questionsFiftyOne','questionsFiftyTwo','questionsFiftyThree','questionsFiftyFour','questionsFiftyFive',
        // 'questionsFiftySix','questionsFiftySeven','questionsFiftyEight','questionsFiftyNine','questionsSixty')); 
