...
// echo "</pre>"; 
    ...
    public function generateInvoice(Request $request, $id)
    {
        ...
        //     $permison=User::roleHasPermissions($role,$permissions);
        //     print_r( $permison);
        // }
        // die();
       
        // User::roleHasPermissions($role,"permission_groups")
        // $permissions=User::getpermissionByGroupName($role->guard_name);
        // User::roleHasPermissions(,"permission_groups")
        // print_r($permission_groups);die();
    ...
    public function add()
    {
        ...
        return view('superadmin.case.create', $data, compact('divisions', 'counties', 'types', 'locations'));
    }
    ...
    public function Store(Request $request)
    {
        ...
        $referral_sex_trafficking = $request->input('referral_sex_trafficking', []);
        $referral_forced_labor = $request->input('referral_forced_labor', []);
        $referral_other_traficking = $request->input('referral_other_traficking', []);
        $referral_unspecified_traficking = $request->input('referral_unspecified_traficking', []);

        $victims_type = $request->input('victims_type', []);
        $victims_sex_trafficking = $request->input('victims_sex_trafficking', []);
        $victims_forced_labor = $request->input('victims_forced_labor', []);
        $victims_other_traficking = $request->input('victims_other_traficking', []);
        $victims_unspecified_traficking = $request->input('victims_unspecified_traficking', []);

        $repatriated_type = $request->input('repatriated_type', []);
        $repatriated_sex_trafficking = $request->input('repatriated_sex_trafficking', []);
        $repatriated_forced_labor = $request->input('repatriated_forced_labor', []);
        $repatriated_other_traficking = $request->input('repatriated_other_traficking', []);
        $repatriated_unspecified_traficking = $request->input('repatriated_unspecified_traficking', []);
        ...
        $maxCount = max(
            ...
            count($referral_type),
            count($referral_sex_trafficking),
            count($referral_forced_labor),
            count($referral_other_traficking),
            count($referral_unspecified_traficking)
            ,
            count($victims_type),
            count($victims_sex_trafficking),
            count($victims_forced_labor),
            count($victims_other_traficking),
            count($victims_unspecified_traficking),
            count($repatriated_type),
            count($repatriated_sex_trafficking),
            count($repatriated_forced_labor),
            count($repatriated_other_traficking),
            count($repatriated_unspecified_traficking)
        );
        ...
        for ($i = 0; $i < $maxCount; $i++) {
            $bulkInsertData[] = [
                ...
                'referral_type' => $referral_type[$i] ?? null,
                'referral_sex_trafficking' => $referral_sex_trafficking[$i] ?? null,
                'referral_forced_labor' => $referral_forced_labor[$i] ?? null,
                'referral_other_traficking' => $referral_other_traficking[$i] ?? null,
                'referral_unspecified_traficking' => $referral_unspecified_traficking[$i] ?? null,
                'victims_type' => $victims_type[$i] ?? null,
                'victims_sex_trafficking' => $victims_sex_trafficking[$i] ?? null,
                'victims_forced_labor' => $victims_forced_labor[$i] ?? null,
                'victims_other_traficking' => $victims_other_traficking[$i] ?? null,
                'victims_unspecified_traficking' => $victims_unspecified_traficking[$i] ?? null,
                'repatriated_type' => $repatriated_type[$i] ?? null,
                'repatriated_sex_trafficking' => $repatriated_sex_trafficking[$i] ?? null,
                'repatriated_forced_labor' => $repatriated_forced_labor[$i] ?? null,
                'repatriated_other_traficking' => $repatriated_other_traficking[$i] ?? null,
                'repatriated_unspecified_traficking' => $repatriated_unspecified_traficking[$i] ?? null,
