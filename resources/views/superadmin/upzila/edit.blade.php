            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ route('superadmin.update.upazila',$upzila->id) }}" method="post">
                    @csrf
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="exampleInputUsername1">Upazila  Name <span style="color:red">*</span></span></label>
                          <input type="text" name="name" class="form-control form-control-sm" value="{{ old('name',$upzila->name) }}" id="exampleInputUsername1"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="bn_name" class="form-control form-control-sm" value="{{ old('bn_name',$upzila->bn_name) }}" id="exampleInputUsername1"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="url" class="form-control form-control-sm" value="{{ old('url',$upzila->url) }}" id="exampleInputUsername1"
                      ...
                      <div class="col-md-12">
                       ...
                       <select class="form-control" name="distric_id" required>
                        ...
                        <option value="{{ $distric->id }}" @if($distric->id == $upzila->distric_id) selected @endif>{{ $distric->name }} {{ $distric->bn_name }}</option>
                        @endforeach
                       </select>
                            <p style="color:red">{{ $errors->first('distric_id') }}</p>
                        </div>
                      </div>
