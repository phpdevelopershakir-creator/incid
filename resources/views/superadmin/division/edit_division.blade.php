            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ route('superadmin.update.division',$division->id) }}" method="post">
                    @csrf
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="exampleInputUsername1">Division  Name <span style="color:red">*</span></span></label>
                          <input type="text" name="name" class="form-control form-control-sm" value="{{ old('name',$division->name) }}" id="exampleInputUsername1"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="bn_name" class="form-control form-control-sm" value="{{ old('bn_name',$division->bn_name) }}" id="exampleInputUsername1"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="url" class="form-control form-control-sm" value="{{ old('url',$division->url) }}" id="exampleInputUsername1"
