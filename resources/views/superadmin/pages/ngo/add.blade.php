...
@endif
                ...
                <div class="card-body">
       <form action="{{ url('superadmin/ngo/store') }}" method="post" class="forms-sample"  enctype="multipart/form-data">
                    @csrf
                  <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select name="name" id="" class="form-control">
                          <option value="INCIDIN Bangladesh">INCIDIN Bangladesh</option>
                          <option value="DAM">DAM</option>
                          <option value="Right Jessore">Right Jessore</option>
                        </select>
                      </div>
                      <div class="form-group col-md-4">
...
@endphp
                      <div class="form-group col-md-3">
                        ...
                        <select name="upazilla_id" class="form-control" id="">
                            ...
                            <option value="{{$upazila->id}}">{{$upazila->name}} {{$upazila->bn_name}} </option>
                            @endforeach
                        </select>
                      </div>
                      <div class="form-group col-md-3">
