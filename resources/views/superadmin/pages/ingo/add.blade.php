...
@endif
                ...
                <div class="card-body">
       <form action="{{ url('superadmin/ingo/store') }}" method="post" class="forms-sample"  enctype="multipart/form-data">
                    @csrf
                  <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select name="name" id="" class="form-control">
                          <option value="WI FSTIP">WI FSTIP</option>
                          <option value="WI Ashshash">WI Ashshash</option>
