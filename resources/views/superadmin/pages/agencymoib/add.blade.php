...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Agency MoIB Create</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Agency MoIB Create</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
@endif
                <div class="card-body">
       <form action="{{ url('superadmin/agencymoib/store') }}" method="post" class="forms-sample"  enctype="multipart/form-data">
                    @csrf
                  <div class="form-row">
@php
                  ...
                  <option value="SSD">SSD</option>                            
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <option value="">Select An Agency</option>       
                            <option value="Bangladesh Betar">Bangladesh Betar</option>
                            <option value="Bangladesh Television">Bangladesh Television</option>
                        </select>
                      </div>
