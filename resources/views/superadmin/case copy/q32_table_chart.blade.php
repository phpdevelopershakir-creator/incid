...
<style type="text/css">
    ...
    th { font-size: 13px }
    td { font-size: 13px }
    .q32-table table th.row_cell, .q32-table table td.row_cell {
        border: 1px solid #000;
    }
    .heading {
        background:'#28a745';
...
<body>
<div class="q32-table-chart">
  <!-- <div class="card card-outline collapsed-card">
    <div class="card-header">
      <h3 class="card-title">32.Did the government train its diplomats not to engage in or facilitate
        trafficking?
      </h3> -->
        <div class="q32-table">
