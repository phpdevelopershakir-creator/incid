...
<style type="text/css">
    ...
    th { font-size: 13px }
    td { font-size: 13px }
    .q54-table table th.row_cell, .q54-table table td.row_cell {
        border: 1px solid #000;
    }
    .heading {
        background:'#28a745';
...
<body>
<div class="q54-table-chart">
  <!-- <div class="card card-outline collapsed-card">
    <div class="card-header">
      <h3 class="card-title">54.Did the government train its diplomats not to engage in or facilitate
        trafficking?
      </h3> -->
        <div class="q54-table">
    
            <table class="table table-bordered" id="q54_individual_activities">
                <thead>
                    <tr>
                    <th rowspan="2" class="row_cell">Category of Trainee</th>  
                    <th rowspan="2" class="row_cell">Number of Training</th>  

                    <th rowspan="2" class="row_cell">Training Contents</th>  

                    <th colspan="8" class="row_cell">Coverage</th>
                    </tr>
                    <tr>
      ...
      <br><br>
      <div class="q54-table">
            <table class="table table-bordered" id="q54_all_participants">
                <thead>
                    <tr>
                    <th rowspan="2" class="row_cell">Category of Trainee</th>  
                    <th rowspan="2" class="row_cell">Number of Training</th>  
