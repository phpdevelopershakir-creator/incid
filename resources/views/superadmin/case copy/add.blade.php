...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Case Create</h1>
        </div>
        <div class="col-sm-6">
 ...
 @include('superadmin.case.question.19question')
   ...
   @include('superadmin.case.question.25question')
    ...
    <div class="col-md-12 question33">
      <div class="card card-outline collapsed-card">
        ...
        <div class="card-body">
          <div class="form-check">
            <input type="radio" id="radioNineteen1" class="thirty_three_status" name="thirty_three_status" checked value="yes">
            <label for="radioNineteen1">
              Yes
            </label>
          </div>
          <div class="form-check">
            <input type="radio" id="radioNineteen2" class="thirty_three_status" name="thirty_three_status"  value="no">
          ...
          <div class="form-check">
            <input type="radio" id="radioNineteen3" class="thirty_three_status" name="thirty_three_status"  value="no">
          ...
          <table class="table table-bordered text-center">
            <thead class="">
              ...
              <tr>
                <td><input type="number" name="thirty_three_one" class="form-control question33RowMen question33Col1" ></td>
                <td><input type="number" name="thirty_three_two" class="form-control question33RowWomen question33Col1"></td>
                <td><input type="number" name="thirty_three_three" class="form-control question33Row3rdGender question33Col1"></td>
                <td><input type="number" name="thirty_three_four" class="form-control question33RowBoys question33Col1"></td>
                <td><input type="number" name="thirty_three_five" id="" class="form-control question33RowGirls question33Col1"></td>
                <td><input type="text" name="thirty_three_six" id="question33Col1" class="form-control q33Total" readonly="true"></td>
              ...
              <tr>
                <td><input type="text" name="thirty_three_seven" class="form-control question33RowMen question33Col2"></td>
                <td><input type="text" name="thirty_three_eight" class="form-control question33RowWomen question33Col2"></td>
                <td><input type="text" name="thirty_three_nine" class="form-control question33Row3rdGender question33Col2"></td>
                <td><input type="text" name="thirty_three_ten" class="form-control question33RowBoys question33Col2"></td>
                <td><input type="text" name="thirty_three_eleven" class="form-control question33RowGirls question33Col2"></td>
                <td><input type="text" name="thirty_three_twelve" id="question33Col2" class="form-control q33Total" readonly="true"></td>
              ...
              <tr>
                <td><input type="text" name="thirty_three_thirteen" id="q33MenTotal" class="form-control q33gTotal" readonly="true"></td>
                <td><input type="text" name="thirty_three_fourteen" id="q33WomenTotal" class="form-control q33gTotal" readonly="true"></td>
                <td><input type="text" name="thirty_three_fifteen" id="q33TrdGTotal" class="form-control q33gTotal " readonly="true"></td>
                <td><input type="text" name="thirty_three_sixteen" id="q33BoysTotal" class="form-control q33gTotal" readonly="true"></td>
                <td><input type="text" name="thirty_three_seventeen" id="q33GirlsTotal" class="form-control q33gTotal" readonly="true"></td>
                <td><input type="text" name="thirty_three_eighteen" id="q33gTotal" class="form-control" readonly="true"></td>
              </tr>
            </thead>
          </table>
        </div>
    ...
    <div class="col-md-12 question34">
     <div class="card card-outline collapsed-card">
       <div class="card-header">
         <h3 class="card-title">34.Did your ministry/agency/organization take any steps to avoid re-traumatization
           of victims in
       ...
       <div class="card-body">
         <div class="form-check">
           <input type="radio" id="radioNineteen1" class="thirty34_fifty_status" name="thirty34_fifty_status" checked value="yes">
           <label for="radioNineteen1">
             Yes
           </label>
         </div>
         <div class="form-check">
           <input type="radio" id="radioNineteen2"  class="thirty34_fifty_status" name="thirty34_fifty_status" value="no">
           <label for="radioNineteen2">
             No
           </label>
         </div>
         ...
         <div class="form-check">
           <input type="radio" id="radioNineteen3" class="thirty34_fifty_status" name="thirty34_fifty_status" value="Others">
           <label for="radioNineteen3">
             Others
           </label>
         </div>
         <div id="34_question_view">
         <table class="table table-bordered text-center">
           <thead class="">
             <tr>
               <th rowspan="2" style="text-align: center; margin: bottom 45%;">Location
                 (multiple-
                 response)</th>
               <th rowspan="2">Types of Assistance</th>
             ...
             <tr>
               <td> <select name="thirty34_one" id="" class="form-control">
               ...
               <td>Psychosocial Counselling</td>
               <td><input type="text" name="thirty34_two" id="" class="form-control question34Col1 question34RowMen"></td>
               <td><input type="text" name="thirty34_three" id="" class="form-control question34Col1 question34RowWomen"></td>
               <td><input type="text" name="thirty34_four" id="" class="form-control question34Col1 question34Row3rdGender"></td>
               <td><input type="text" name="thirty34_five" id="" class="form-control question34Col1 question34RowBoys"></td>
               <td><input type="text" name="thirty34_six" id="" class="form-control question34Col1 question34RowGirls"></td>
               <td><input type="text" name="thirty34_seven" id="question34Col1" class="form-control" readonly="true"></td>
             </tr>
             <tr>
               <td><select name="thirty34_eight" id="" class="form-control">
               <option value="">--choose Location--</option>
                   <option value="Barisal">Barisal</option>
                   <option value="Chattogram">Chattogram</option>
                   <option value="Dhaka">Dhaka</option>
               ...
               <td>Shelter</td>
               <td><input type="text" name="thirty34_night" id="" class="form-control question34Col2 question34RowMen"></td>
               <td><input type="text" name="thirty34_ten" id="" class="form-control question34Col2 question34RowWomen"></td>
               <td><input type="text" name="thirty34_eleven" id="" class="form-control question34Col2 question34Row3rdGender"></td>
               <td><input type="text" name="thirty34_twelve" id="" class="form-control question34Col2 question34RowBoys"></td>
               <td><input type="text" name="thirty34_thirteen" id="" class="form-control question34Col2 question34RowGirls"></td>
               <td><input type="text" name="thirty34_fourteen" id="question34Col2" class="form-control" readonly="true"></td>
             </tr>

             <tr>
               <td><select name="thirty34_fifteen" id="" class="form-control">
               <option value="">--choose Location--</option>
                   <option value="Barisal">Barisal</option>
                   <option value="Chattogram">Chattogram</option>
                   <option value="Dhaka">Dhaka</option>
               ...
               <td>Assistance to persons with disability</td>
               <td><input type="text" name="thirty34_sixteen" id="" class="form-control question34Col3 question34RowMen"></td>
               <td><input type="text" name="thirty34_seventeen" id="" class="form-control question34Col3 question34RowWomen"></td>
               <td><input type="text" name="thirty34_eighteen" id="" class="form-control question34Col3 question34Row3rdGender"></td>
               <td><input type="text" name="thirty34_nineteen" id="" class="form-control question34Col3 question34RowBoys"></td>
               <td><input type="text" name="thirty34_twenty" id="" class="form-control question34Col3 question34RowGirls"></td>
               <td><input type="text" name="thirty34_twenty_one" id="question34Col3" class="form-control" readonly="true"></td>
             </tr>

             <tr>
               <td><select name="thirty34_twenty_two" id="" class="form-control">
               <option value="">--choose Location--</option>
                   <option value="Barisal">Barisal</option>
                   <option value="Chattogram">Chattogram</option>
                   <option value="Dhaka">Dhaka</option>
               ...
               <td>Testimony via video or written statements</td>
               <td><input type="text" name="thirty34_twenty_three" id="" class="form-control question34Col4 question34RowMen"></td>
               <td><input type="text" name="thirty34_twenty_four" id="" class="form-control question34Col4 question34RowWomen"></td>
               <td><input type="text" name="thirty34_twenty_five" id="" class="form-control question34Col4 question34Row3rdGender"></td>
               <td><input type="text" name="thirty34_twenty_six" id="" class="form-control question34Col4 question34RowBoys"></td>
               <td><input type="text" name="thirty34_twenty_seven" id="" class="form-control question34Col4 question34RowGirls"></td>
               <td><input type="text" name="thirty34_twenty_eight" id="question34Col4" class="form-control" readonly="true"></td>
             </tr>


             <tr>
               <td><select name="thirty34_twenty_night" id="" class="form-control">
               <option value="">--choose Location--</option>
                   <option value="Barisal">Barisal</option>
                   <option value="Chattogram">Chattogram</option>
                   <option value="Dhaka">Dhaka</option>
               ...
               <td>
                 <div class="RightContaner"> Others (Specify)</div>
                 <div class="LeftContaner"> <input type="text" name="thirty34_thirty" class="form-control" width="100%"> </div>
               </td>
               <td><input type="text" name="thirty34_thirty_one" id="" class="form-control question34Col5 question34RowMen"></td>
               <td><input type="text" name="thirty34_thirty_two" id="" class="form-control question34Col5 question34RowWomen"></td>
               <td><input type="text" name="thirty34_thirty_three" id="" class="form-control question34Col5 question34Row3rdGender"></td>
               <td><input type="text" name="thirty34_thirty_four" id="" class="form-control question34Col5 question34RowBoys"></td>
               <td><input type="text" name="thirty34_thirty_five" id="" class="form-control question34Col5 question34RowGirls"></td>
               <td><input type="text" name="thirty34_thirty_six" id="question34Col5" class="form-control" readonly="true"></td>
             </tr>
             <tr>
               <td><select name="thirty34_thirty_seven" id="" class="form-control">
               <option value="">--choose Location--</option>
                   <option value="Barisal">Barisal</option>
                   <option value="Chattogram">Chattogram</option>
                   <option value="Dhaka">Dhaka</option>
               ...
               <td>
                 <div class="RightContaner"> Others (Specify)</div>
                 <div class="LeftContaner"> <input type="text" name="thirty34_thirty_eight" class="form-control" width="100%"> </div>
               </td>
               <td><input type="text" name="thirty34_thirty_nine" id="" class="form-control question34Col6 question34RowMen"></td>
               <td><input type="text" name="thirty34_forty" id="" class="form-control question34Col6 question34RowWomen"></td>
               <td><input type="text" name="thirty34_forty_one" id="" class="form-control question34Col6 question34Row3rdGender"></td>
               <td><input type="text" name="thirty34_forty_two" id="" class="form-control question34Col6 question34RowBoys"></td>
               <td><input type="text" name="thirty34_forty_three" id="" class="form-control question34Col6 question34RowGirls"></td>
               <td><input type="text" name="thirty34_forty_four" id="question34Col6" class="form-control" readonly="true"></td>
             </tr>

             <tr>
               <td><select name="thirty34_forty_five" id="" class="form-control">
               <option value="">--choose Location--</option>
                   <option value="Barisal">Barisal</option>
                   <option value="Chattogram">Chattogram</option>
                   <option value="Dhaka">Dhaka</option>
               ...
               <td>
                 <div class="RightContaner"> Others (Specify)</div>
                 <div class="LeftContaner"> <input type="text" name="thirty34_forty_six" class="form-control" width="100%"> </div>
               </td>
               <td><input type="text" name="thirty34_forty_seven" id="" class="form-control question34Col7 question34RowMen"></td>
               <td><input type="text" name="thirty34_forty_eight" id="" class="form-control question34Col7 question34RowWomen"></td>
               <td><input type="text" name="thirty34_forty_nine" id="" class="form-control question34Col7 question34Row3rdGender"></td>
               <td><input type="text" name="thirty34_fifty" id="" class="form-control question34Col7 question34RowBoys"></td>
               <td><input type="text" name="thirty34_fifty_one" id="" class="form-control question34Col7 question34RowGirls"></td>
               <td><input type="text" name="thirty34_fifty_two" id="question34Col7" class="form-control" readonly="true"></td>
             </tr>
           </thead>
         </table>
        </div>
   ...
   @endif
      ...
      <div class="card card-outline collapsed-card">
        <div class="card-header">
          <h3 class="card-title">36.Please list the number of individuals or cases, investigation, prosecution,
            or
            conviction for sex trafficking, labour trafficking/forced labour and other forms of trafficking
            (e.g.
        ...
        <div class="card-body">
          ...
          <table cellpadding=0 celspecing=0 width="100%">
            ...
            <tr>
              <td rowspan=5>Individuals/cases (new this reporting period)</td>
            ...
            <tr>
              <td rowspan=5>Individuals/cases investigated (ongoing from the previous
                reporting period)
                </td>
              <td>Number of Victims of Sex Trafficking Cases</td>
              <td> <input type="text" name="" id="" class="form-control"></td>
            ...
            <tr>
              <td rowspan=5>Individuals/cases investigated (new this reporting period)</td>
              <td>Number of Victims of Sex Trafficking Cases</td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
            ...
            <tr>
              <td rowspan=5>Individuals/cases investigated (new this
                reporting period)
                </td>
              <td>Number of Victims of Sex Trafficking Cases</td>
              <td> <input type="text" name="" id="" class="form-control"></td>
            ...
            <tr>
              <td rowspan=5>Individuals/cases investigated (ongoing from the previous reporting period)
                </td>
              <td>Number of Victims of Sex Trafficking Cases</td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
    ...
    <div class="col-md-12">
      <div class="card card-outline collapsed-card">
        <div class="card-header">
          <h3 class="card-title"> 37.Prosecution</h3>
        ...
        <div class="card-body">
          ...
          <table cellpadding=0 celspecing=0 width="100%">
            ...
            <tr>
              <td rowspan=3>Total individuals/cases prosecuted</td>
              <td>Number of Victims of Sex Trafficking Cases</td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
            ...
            <tr>
              <td rowspan=3>Individuals/cases prosecuted (new this reporting period)
              </td>
              <td>Number of Victims of Sex Trafficking Cases</td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
            ...
            <tr>
              <td rowspan=3>Individuals/cases prosecuted (ongoing from the previous
                reporting period)
            ...
            <tr>
              <td rowspan=3>Individuals/cases prosecuted (new)</td>
              <td>Number of Victims of Sex Trafficking Cases</td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
            ...
            <tr>
              <td rowspan=3>Individuals/cases prosecuted (ongoing)
              </td>
              <td>Number of Victims of Sex Trafficking Cases</td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
            ...
            <tr>
              <td rowspan=3>individuals prosecuted/cases under PSHT Act 2012</td>
              <td>Number of Victims of Sex Trafficking Cases</td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
            ...
            <tr>
              <td rowspan=3>individuals/cases prosecuted under non-trafficking laws (OEMA/PC)</td>
              <td>Number of Victims of Sex Trafficking Cases</td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
              <td> <input type="text" name="" id="" class="form-control"></td>
...
$(document).ready(function() {
    ...
    $(document).on('input', '.question24ColMen', function() {
      updateTotal('.question24ColMen', '#menRowSum');
      updateTotal('.gTotal', '#gTotal');
    });
    ...
    $(document).on('input', '.question24rowmen', function() {
      updateTotal('.question24rowmen', '#question24rowMenTotal');
      updateTotal('.gTotal', '#gTotal');

    });

    $(document).on('input', '.question24rowWomen', function() {
      updateTotal('.question24rowWomen', '#question24rowWomenTotal');
      updateTotal('.gTotal', '#gTotal');
    });
    

    $(document).on('input', '.question24row3rdG', function() {
      updateTotal('.question24row3rdG', '#question24row3rdGTotal');
      updateTotal('.gTotal', '#gTotal');
