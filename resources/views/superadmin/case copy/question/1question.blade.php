...
?>
        ...
        <div id="Question-1" class="collapse" role="tabpane1" aria-labelledby="heading-4"
          ...
          <?php if(isset($question_1_data_one->q1_checked_value)) { ?>
            ...
            <input type="radio" id="radioSeven1" class="sevenstatus" name="is_supreme_court_q1" checked value="1">
            <?php } ?>    
       ...
       <table id="addRowQ10" class="table table-bordered text-center">
        ...
        <?php if(isset($question_1_data_one->q10_data) && count($question_1_data_one->q10_data)>0){ $i=0; ?>
          ...
          <tr class="qe10NoOfRow" id="row<?=$i;?>">
            ...
            <td>
              <select name="supreme_court_status[]" id="q10TrainingResponse" class="form-control q10Input">
                <option value="" disabled selected>---Choose an item--</option>
      ...
      <table id="addRow2Q10" class="table table-bordered text-center">
        ...
        <?php if(isset($question_10_data->q10_data) && count($question_10_data->q10_data)>0){ $i=0; ?>
          ...
          <tr class="qe10NoOfRow2" id="row<?=$i;?>">
            ...
            <td>
              <select name="supreme_court_status_two[]" id="q10TrainingResponse" class="form-control q10Input">
                <option value="" disabled selected>---Choose an item--</option>
        ...
        <?php }else { ?>
          ...
          <tr class="qe10NoOfRow2">
           <td> <input type="text" name="supreme_court_title_two[]" value="<?=(isset($q10)  &&  !empty($q10) && $q10->total_coverage) ? $q10->total_coverage : '' ;?>" id="q10traficTotal" class="form-control q10Input"> </td>
            ...
            <td> <input type="file" name="supreme_court_image_two[]"  class="form-control"> </td>
            <td><button id="addRowDatasQ210" type="button" class="btn btn-sm btn-primary">+</i></button></td>
...
<script>
  ...
  $(function(){
    // var rowCount = 1;
    $("#addRowDatasQ210").click(function(){
      let rowCount =$('.qe10NoOfRow').length+1
      $("#addRow2Q10").append(
        '<tr class="qe10NoOfRow" id="row'+rowCount+'">'+
        `<td>
