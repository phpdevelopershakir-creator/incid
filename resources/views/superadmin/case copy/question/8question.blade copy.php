...
<div class="card question8">
        ...
        <h6 class="card-title" style="color: {{ isset($question_8_data) ? 'blue' : 'green' }};">
        ...
        <div id="Question-8" class="collapse" role="tabpane8" aria-labelledby="heading-4"
          ...
          <div class="icheck-primary icheck-primary input-group">
            ...
            <label for="radioEight3">
              Others 
            </label> </label> <span class=" col-md-6 mt--4 <?=(isset($question_8_data->q8_checked_value) && $question_8_data->q8_checked_value=="2")? "" :"othersText" ;?>" >
            <input 
            type="text" 
            id="q7others"   
            placeholder="Others "  
          ...
          <div id="eight_question_view" class="<?=(isset($question_8_data->q8_checked_value)) && ($question_8_data->q8_checked_value=="2" || $question_8_data->q8_checked_value=="0" )?"visibility":"" ;?>">
    ...
    <td >
        ...
        value="<?= (isset($question_8_data->q8_data->police_station)) ? $question_8_data->q8_data->police_station : ""; ?>">
    </td>
            <td>
             &nbsp;
            </td>
    ...
    <td >
        <input type="text" name="court_description_q8[]" class="form-control desc-td" style="display:none;"
        value="<?= (isset($question_8_data->q8_data->cid)) ? $question_8_data->q8_data->cid : ""; ?>">
    </td>
            <td>
             &nbsp;
            </td>
         ...
         <td >
        <input type="text" name="court_description_q8[]" class="form-control desc-td" style="display:none;"
        value="<?= (isset($question_8_data->q8_data->rab)) ? $question_8_data->q8_data->rab : ""; ?>">
    </td>
            <td>
             &nbsp;
            </td>
    ...
    <td >
        <input type="text" name="court_description_q8[]" class="form-control desc-td" style="display:none;"
        value="<?= (isset($question_8_data->q8_data->sb)) ? $question_8_data->q8_data->sb : ""; ?>">
    </td>
            <td>
             &nbsp;
            </td>
         ...
         <td >
        <input type="text" name="court_description_q8[]" class="form-control desc-td" style="display:none;"
        value="<?= (isset($question_8_data->q8_data->prosecution_offices)) ? $question_8_data->q8_data->prosecution_offices : ""; ?>">
    </td>
            <td>
             &nbsp;
            </td>
    ...
    <td >
        <input type="text" name="court_description_q8[]" class="form-control desc-td" style="display:none;"
        value="<?= (isset($question_8_data->q8_data->special_tribunal)) ? $question_8_data->q8_data->special_tribunal : ""; ?>">
    </td>
            <td>
             &nbsp;
            </td>
          ...
          <!-- test end -->
<?php if(isset($question_8_data->q8_other_data) && is_array($question_8_data->q8_other_data) && count($question_8_data->q8_other_data) > 0){ ?>
                
          @foreach($question_8_data->q8_other_data as $index => $other_data)
    ...
    $(document).on("click", '#temp-save-question8', function() {
        ...
        if(yes_no_value == "1"){
          ...
          $('tr.qe8NoOfRow').each(function() {
              ...
              q8_data[title] = description; // set key-value pair
          });
