          ...
          <table class="table table-white table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <input type="hidden" name="original_approach_q63[]" value="1"> 
                <td> <select name="description_change_q63[]" id="q11Description1" class="form-control q61Input">
                <!-- @include('superadmin.case.helper.11change') -->
                <option value="" selected>---Choose an item--</option>
                  
                @foreach($q11_status as $key=>$item)
                    <option <?=(isset($question_61_data->q11_data) &&  !empty($question_61_data->q11_data) && $question_61_data->q11_data->q11Description1==$key) ? 'selected' : '' ;?>  value="{{$key}}">{{$item}}</option>
                  @endforeach
                  </select> </td>
              </tr>
              <tr>
                <th scope="row">Employee-paid-model</th>
                <input type="hidden" name="original_approach_q63[]" value="2"> 
                <td> <select name="description_change_q63[]" id="q11Description2" class="form-control q61Input">
                <!-- @include('superadmin.case.helper.11change') -->
                <option value="" selected>---Choose an item--</option>
                  
                  @foreach($q11_status as $key=>$item)
                      <option <?=(isset($question_61_data->q11_data) &&  !empty($question_61_data->q11_data) && $question_61_data->q11_data->q11Description2==$key) ? 'selected' : '' ;?>  value="{{$key}}">{{$item}}</option>
                    @endforeach
                  </select></td>
              </tr>
              ...
              <tr>
                ...
                <input type="hidden" name="original_approach_q63[]" value="3"> 
                <td> <select name="description_change_q63[]" id="q11Description3" class="form-control q61Input">
                <!-- @include('superadmin.case.helper.11change') -->
                <option value="" selected>---Choose an item--</option>
                  
                  @foreach($q11_status as $key=>$item)
                      <option <?=(isset($question_61_data->q11_data) &&  !empty($question_61_data->q11_data) && $question_61_data->q11_data->q11Description3==$key) ? 'selected' : '' ;?>  value="{{$key}}">{{$item}}</option>
                    @endforeach
                  </select> </td>
              </tr>
              <tr>
              ...
              <tr>
                <th scope="row">
                  <div class="RightContaner"> Others (Specify)</div>
                  <div class="LeftContaner"> <input type="text" name="original_approach_q63[]" id="q11Other4" value="<?=(isset($question_61_data->q11_data->q11Other4))?$question_61_data->q11_data->q11Other4:"";?>" class="form-control q61Input" width="100%"> </div>
                </th>
                <td> <input type="text" name="description_change_q63[]" id="q11DescriptionChange" value="<?=(isset($question_61_data->q11_data->q11DescriptionChange))?$question_61_data->q11_data->q11DescriptionChange:"";?>" class="form-control q61Input"> </td>
              </tr>
            </tbody>
          </table>
        </div>
