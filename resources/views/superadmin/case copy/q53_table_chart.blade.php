...
<style type="text/css">
    ...
    th { font-size: 13px }
    td { font-size: 13px }
    .q53-table table th.row_cell, .q53-table table td.row_cell {
        border: 1px solid #000;
    }
    .heading {
        background:'#28a745';
...
<body>
<div class="q53-table-chart">
  <!-- <div class="card card-outline collapsed-card">
    <div class="card-header">
      <h3 class="card-title">53.Did the government train its diplomats not to engage in or facilitate
        trafficking?
      </h3> -->
        <div class="q53-table">
    
            <table class="table table-bordered" id="q53_individual_activities">
                <thead>
                    <tr>
                    <th rowspan="2" class="row_cell">Number of Case</th>  
                    <th colspan="16" class="row_cell">Individual Coverage</th>
                    </tr>
                    <tr>
      ...
      <br><br>
      <div class="q53-table">
            <table class="table table-bordered" id="q53_all_participants">
                <thead>
                    <tr>
                    <th rowspan="2" class="row_cell">Number of Case</th>  
                    <th colspan="16" class="row_cell">Individual Coverage</th>
