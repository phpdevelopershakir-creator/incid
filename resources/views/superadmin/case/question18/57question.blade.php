        ...
        <table id="resources_funding" class="table table-bordered table-white <?= (isset($question_57_data->q57_checked_value)) && ($question_57_data->q57_checked_value == "2" || $question_57_data->q57_checked_value == "0") ? "visibility" : ""; ?>">
          ...
          <tbody>
            <tr>
              ...
              <td> <input type="text" id="totalAllocateIunderNpa" value="<?= isset($question_57_data->q57_data->totalAllocateIunderNpa) ? $question_57_data->q57_data->totalAllocateIunderNpa : ''   ?>" name="allocation_status[]" class="form-control q8Input"> </td>
            </tr>
            <tr>
              <th scope="row">Total Allocation utilized under NPA </th>
              <input type="hidden" name="allocation_under_npa[]" value="2">
              <td> <input type="text" id="totalAllocateNpa" value="<?= isset($question_57_data->q57_data->totalAllocateNpa) ? $question_57_data->q57_data->totalAllocateNpa : ''   ?>" name="allocation_status[]" class="form-control q8Input"> </td>

            </tr>
            <tr>
              <th scope="row">Assessment of Allocation </th>
              <input type="hidden" name="allocation_under_npa[]" value="3">
              <td> <select name="allocation_status[]" id="q57_ases_allocate" class="form-control q8Input">
                  <option <?= isset($question_57_data->q57_data->q57_ases_allocate) && $question_57_data->q57_data->q57_ases_allocate == 'Excess' ? 'selected' : ''   ?> value="Excess">Excess</option>
                  <option <?= isset($question_57_data->q57_data->q57_ases_allocate) && $question_57_data->q57_data->q57_ases_allocate == 'Adequate' ? 'selected' : ''   ?> value="Adequate">Adequate</option>
                  <option <?= isset($question_57_data->q57_data->q57_ases_allocate) && $question_57_data->q57_data->q57_ases_allocate == 'Inadequate' ? 'selected' : ''   ?> value="Inadequate">Inadequate</option>
                  <option <?= isset($question_57_data->q57_data->q57_ases_allocate) && $question_57_data->q57_data->q57_ases_allocate == 'None' ? 'selected' : ''   ?> value="None">None</option>
                </select>
              </td>
            </tr>
          </tbody>
