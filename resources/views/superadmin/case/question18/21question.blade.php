              ...
              @for($i=1;$i<=4;$i++)
                ...
                <td>
                  <input type="number" name="capacity_men_q21[]" id="q21Men{{$i}}" class="form-control question21rowmen q21Input"
                    value="{{ $question_21_data->q21_data->{'q21Men'.$i} ?? 0 }}" min="0">
                  <p style="color:red">{{ $errors->first('capacity_men_q21.0') }} </p>
                </td>

                <td>
                  <input type="number" name="capacity_women_q21[]" id="q21Women{{$i}}" class="form-control question21rowWomen q21Input"
                    value="{{ $question_21_data->q21_data->{'q21Women'.$i} ?? 0 }}" min="0">
                    <p style="color:red">{{ $errors->first('capacity_women_q21.0') }} </p>
                </td>
                ...
                <td>
                  <input type="text"
                    name="capacity_total_q21[]"
                    id="rowTotal{{$i}}"
                    class="form-control q21Input"
                    readonly
                    value="{{ ($question_21_data->q21_data->{'q21Men'.$i} ?? 0) + ($question_21_data->q21_data->{'q21Women'.$i} ?? 0) }}" min="0">
                    <p style="color:red">{{ $errors->first('capacity_total_q21.0') }} </p>
                </td>
