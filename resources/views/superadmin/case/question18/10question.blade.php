        ...
        <div id="Question-10" class="collapse" role="tabpane10" aria-labelledby="heading-4"
            ...
            <div class="card-body">
                <div class="icheck-primary">
                    <?php if (isset($question_8a_data->q10_checked_value)) { ?>
                        <input
                            type="radio"
                            id="radioEight1"
                            class="eightstatus"
                            name="is_exclusively_trafficking_q10"
                            <?= (isset($question_8a_data->q10_checked_value) && $question_8a_data->q10_checked_value == "1") ? "checked" : ""; ?>
                            value="1">
                    <?php } else { ?>

                        <input type="radio" id="radioEight1" class="eightstatus" name="is_exclusively_trafficking_q10" checked value="1">
                    <?php } ?>
                ...
                <div class="icheck-primary">
                    <input
                        ...
                        class="eightstatus"
                        name="is_exclusively_trafficking_q10"
                        <?= (isset($question_8a_data->q10_checked_value) && $question_8a_data->q10_checked_value == "0") ? "checked" : ""; ?>
                ...
                <div class="icheck-primary icheck-primary input-group">
                    <input
                        ...
                        class="eightstatus"
                        name="is_exclusively_trafficking_q10"
                        <?= (isset($question_8a_data->q10_checked_value) && $question_8a_data->q10_checked_value == "2") ? "checked" : ""; ?>
                        value="2">
                    <label for="radioEight3">
                        Others
                    </label> </label> <span class=" col-md-6 mt--4 <?= (isset($question_8a_data->q10_checked_value) && $question_8a_data->q10_checked_value == "2") ? "" : "othersText"; ?>">
                        <input
                            type="text"
                            id="q7others"
                            placeholder="Others "
                            ...
                            name="other_exclusively_trafficking_q10"></span>
                </div>
                <div id="eight_question_view" class="<?= (isset($question_8a_data->q10_checked_value)) && ($question_8a_data->q10_checked_value == "2" || $question_8a_data->q10_checked_value == "0") ? "visibility" : ""; ?>">
                        ...
                        <tbody>
                            ...
                            <tr class="qe8NoOfRow">
                                <td data-title="police_station" style="text-align: left;">
                                    Police Station
                                    <input type="hidden" class="form-control" name="court_title_q10[]" value="Police Station">
                                </td>
                                <td>
                                    <div class="radio-group-vertical">
                                        ...
                                        <input type="hidden" name="court_type_q10[]" class="courtTypeHolder8">
                                    </div>
                                </td>
                            ...
                            <tr class="qe8NoOfRow">
                                <td data-title="cid" style="text-align: left;">
                                    CID
                                    <input type="hidden" class="form-control" name="court_title_q10[]" value="CID">
                                </td>
                                <td>
                                    <div class="radio-group-vertical">
                                        <label>
                            ...
                            <tr class="qe8NoOfRow">
                                <td data-title="rab" style="text-align: left;">
                                    RAB
                                    <input type="hidden" class="form-control" name="court_title_q10[]" value="RAB">
                                </td>
                                <td>
                                    <div class="radio-group-vertical">
                                        <label>
                            ...
                            <tr class="qe8NoOfRow">
                                <td data-title="sb" style="text-align: left;">
                                    SB
                                    <input type="hidden" class="form-control" name="court_title_q10[]" value="SB">
                                </td>
                                <td>
                                    <div class="radio-group-vertical">
                                        <label>
                            ...
                            <tr class="qe8NoOfRow">
                                <td data-title="prosecution_offices" style="text-align: left;">
                                    ...
                                    <input type="hidden" class="form-control" name="court_title_q10[]" value="Prosecution offices (SPP)">
                                </td>
                                <td>
                                    <div class="radio-group-vertical">
                                        <label>
                            ...
                            <tr class="qe8NoOfRow">
                                <td data-title="special_tribunal" style="text-align: left;">
                                    Special Tribunal
                                    <input type="hidden" class="form-control" name="court_title_q10[]" value="Special Tribunal">
                                </td>
                                <td>
                                    <div class="radio-group-vertical">
                                        <label>
                            ...
                            <!-- test end -->
                            <?php if (isset($question_8a_data->q10_other_data) && is_array($question_8a_data->q10_other_data) && count($question_8a_data->q10_other_data) > 0) { ?>

                                @foreach($question_8a_data->q10_other_data as $index => $other_data)
                                <tr class="qe8NoOfRowOthers" id="row{{$index}}">
                                    <td>
                                        <input type="text" name="court_title_q10[]" class="form-control" value="{{$other_data->court_title_q10}}" placeholder="Others Specific">
                                    </td>
                                    <td>
                                        <div class="radio-group-vertical">
                                            <label>
                                    ...
                                    <td>
                                        <input type="text" name="court_description_q10[]" value="{{$other_data->court_description_q10}}" class="form-control desc-td" style="display:none;">
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
        ...
        $(document).on("click", '#temp-save-question10', function() {
            ...
            if (yes_no_value == "1") {
                ...
                $('tr.qe8NoOfRow').each(function() {
                    ...
                    let description = $(this).find('input[name="court_description_q10[]"]').val(); // text input
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response) {
                        $('.question10.card-title').css('color', 'green');
