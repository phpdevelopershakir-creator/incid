...
<div class="card">
    <div class="card-header" role="tab" id="heading-4">
        <h6 class="mb-0">
            <a data-toggle="collapse" href="#Question-530" aria-expanded="false" aria-controls="collapse-4">
                54.{{ $questiontitles[53]->title }}
            </a>
        </h6>
    </div>

    <div id="Question-530" class="collapse" role="tabpane530" aria-labelledby="heading-4" data-parent="#accordion-2">
        <div class="card-body">
            <div id="six_question_view">
                @if(isset($case->yes_no_other) && $case->yes_no_other->is_country_diplomats_allegedly_q54 == 1)
                ...
                <div class="alert alert-info">
                    <strong>Other Description:</strong> {{ $case->yes_no_other->other_country_diplomats_allegedly_q54 }}
                </div>
