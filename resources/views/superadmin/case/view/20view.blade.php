    ...
    <div id="Question-20" class="collapse" role="tabpane20" aria-labelledby="heading-4"
      ...
      <div class="card-body">
        <div id="six_question_view">
          @if(isset($case->yes_no_other) && $case->yes_no_other->is_describe_government_operated_q20 == 1)
          ...
          @elseif(isset($case->yes_no_other) && !empty($case->yes_no_other->other_describe_government_operated_q20))
          <div class="alert alert-info">
            <strong>Other Description:</strong> {{ $case->yes_no_other->other_describe_government_operated_q20 }}
          </div>
