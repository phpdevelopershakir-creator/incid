    ...
    <div id="Question-7" class="collapse" role="tabpane7" aria-labelledby="heading-4"
      ...
      <div class="card-body">
        <div id="six_question_view">
          @if(isset($case->yes_no_other) && $case->yes_no_other->is_exclusively_dedicated_trafficking_q7 == 1)
          ...
          @elseif(isset($case->yes_no_other) && !empty($case->yes_no_other->other_exclusively_dedicated_trafficking_q7))
          <div class="alert alert-info">
            <strong>Other Description:</strong> {{ $case->yes_no_other->other_exclusively_dedicated_trafficking_q7 }}
          </div>
