    ...
    ?>
     ...
     <div class="card question57">
       ...
       <div id="Question-45" class="collapse" role="tabpane45" aria-labelledby="heading-4"
         ...
         @if(isset($case->yes_no_other) && $case->yes_no_other->is_national_plan_trafficking_q45 == 1)
         ...
         @elseif(isset($case->yes_no_other) && !empty($case->yes_no_other->other_national_plan_trafficking_q45))
         <div class="alert alert-info">
           <strong>Other Description:</strong> {{ $case->yes_no_other->other_national_plan_trafficking_q45 }}
         </div>
