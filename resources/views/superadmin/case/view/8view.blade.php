    ...
    <div id="Question-8" class="collapse" role="tabpane8" aria-labelledby="heading-4"
      ...
      <div class="card-body">
        <div id="six_question_view">
          ...
          <table class="table table-white table-bordered">
            <thead class="text-center align-middle">
              <tr style="background:#E5E5E5;">
                <th rowspan="2" class="text-center" style="vertical-align: middle; padding-bottom: 20px;">Ministry/Department Municipality body</th>
                <!-- <th rowspan="2">Description of change/Status</th> -->
                <th colspan="4" class="text-center" style="vertical-align: middle; padding-bottom: 20px;">Measures Taken</th>
          ...
          @elseif(isset($case->yes_no_other) && !empty($case->yes_no_other->other_involved_directly_trafficking_8q))
          <div class="alert alert-info">
            <strong>Other Description:</strong> {{ $case->yes_no_other->other_involved_directly_trafficking_8q }}
          </div>
