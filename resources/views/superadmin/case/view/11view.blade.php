  ...
  <div class="card">
    ...
    <div id="Question-11" class="collapse" role="tabpane11" aria-labelledby="heading-4"
      ...
      <div class="card-body">
        ...
        @elseif(isset($case->yes_no_other) && !empty($case->yes_no_other->other_government_agreements_transparent_q11))
        <div class="alert alert-info">
          <strong>Other Description:</strong> {{ $case->yes_no_other->other_government_agreements_transparent_q11 }}
        </div>
