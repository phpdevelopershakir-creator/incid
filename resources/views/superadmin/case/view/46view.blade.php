    ...
    ?>
     ...
     <div class="card question57">
       ...
       <div id="Question-46" class="collapse" role="tabpane46" aria-labelledby="heading-4"
         ...
         @elseif(isset($case->yes_no_other) && !empty($case->yes_no_other->other_government_conduct_awareness_activities_q46))
         <div class="alert alert-info">
           <strong>Other Description:</strong> {{ $case->yes_no_other->other_government_conduct_awareness_activities_q46 }}
         </div>
