    ...
    <div id="Question-1" class="collapse" role="tabpanel1" aria-labelledby="heading-4"
      ...
      <div class="card-body">
        <div id="six_question_view">
          ...
          @elseif(isset($case->yes_no_other) && !empty($case->yes_no_other->others_supreme_court_q1))
          <div class="alert alert-info">
            <strong>Other Description:</strong> {{ $case->yes_no_other->others_supreme_court_q1 }}
          </div>
