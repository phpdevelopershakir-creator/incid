    ...
    <div id="Question-53" class="collapse" role="tabpane53" aria-labelledby="heading-4"
      ...
      <div class="card-body">
        <div id="six_question_view">
          @if(isset($case->yes_no_other) && $case->yes_no_other->is_government_train_diplomat_q53 == 1)
          ...
          @elseif(isset($case->yes_no_other) && !empty($case->yes_no_other->other_government_train_diplomat_q53))
          <div class="alert alert-info">
            <strong>Other Description:</strong> {{ $case->yes_no_other->other_government_train_diplomat_q53 }}
          </div>
