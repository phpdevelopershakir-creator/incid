    ...
    ?>
     ...
     <div class="card question57">
       ...
       <div id="Question-44" class="collapse" role="tabpane44" aria-labelledby="heading-4"
         ...
         <table class="table table-white table-bordered">
           <thead class="text-center align-middle">
             <tr style="background:#E5E5E5;">
               <th scope="col" class="text-center" style="vertical-align: middle; padding-bottom: 20px;">Allocation</th>
               <th scope="col" class="text-center" style="vertical-align: middle; padding-bottom: 20px;">Allocation</th>
             </tr>
           </thead>
           <tbody>
         ...
         @elseif(isset($case->yes_no_other) && !empty($case->yes_no_other->other_awareness_campaigns_research_projects_q44))
         <div class="alert alert-info">
           <strong>Other Description:</strong> {{ $case->yes_no_other->other_awareness_campaigns_research_projects_q44 }}
         </div>
