...
<style type="text/css">
    ...
    th { font-size: 13px }
    td { font-size: 13px }
    .q33-table table th.row_cell, .q33-table table td.row_cell {
        border: 1px solid #000;
    }
    .heading {
        background:'#28a745';
...
<body>
<div class="q33-table-chart">
  <!-- <div class="card card-outline collapsed-card">
    <div class="card-header">
      <h3 class="card-title">33.Did the government train its diplomats not to engage in or facilitate
        trafficking?
      </h3> -->
        <div class="q33-table">
            ...
            <table class="table table-bordered" id="q33_individual_activities">
                <thead>
                    <tr>
                        <th rowspan="2" class="row_cell">Types of Trafficking</th>              
                        <th colspan="16" class="row_cell">VoT participating in investigation/prosecution</th>
                    </tr>
                    <tr>
