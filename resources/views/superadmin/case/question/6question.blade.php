        ...
        <div class="card-body">
            ...
            <div class="icheck-primary input-group mb-3">
                ...
                <span class="col-md-6 mt--4 others_input_container {{ $q6_checked == "2" ? '' : 'othersText' }}">
                    <input type="text" id="q6radioThree3others" class="form-control" placeholder="Please describe"
                ...
                <table id="addRowq6radioThree3" class="table table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr class="q6radioSix6QRow" id="q6row{{ $i }}">
                            <td>
                                <select name="labor_title_q6[]" class="form-control  select-type-hotline">
                                    @foreach ($ministry_q6 as $key => $item)
                                    <option value="{{ $key }}">{{$item}}</option>
                                    @endforeach
                                </select>
                            </td>
                            <td>
                                <input type="number" name="labor_men_q6[]" id="labor_men_q6_{{ $i }}"
                                    class="form-control labor_men_q6" value="{{ $q6['men'] ?? 0 }}" min="0">
                            </td>
                            <td>
                                <input type="number" name="labor_women_q6[]" id="labor_women_q6_{{ $i }}"
                                    class="form-control labor_women_q6" value="{{ $q6['women'] ?? 0 }}" min="0">
                            </td>
                            <td>
                                <input type="number" name="labor_total_q6[]" readonly id="labor_total_q6_{{ $i }}"
                                    class="form-control labor_total_q6" value="{{ $q6['total'] ?? 0 }}">
                            </td>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-sm btn-primary"
                                    id="addRowDatasq6radioThree3">+</button>
                                @else
                                <button type="button" id="{{ $i }}"
                                    class="btn btn-danger q6radioThree3btn_remove">-</button>
                                @endif
                            </td>
                        </tr>
                        @php $i++; @endphp
                        ...
                        <tr class="q6radioSix6QRow" id="q6row1">
                            ...
                            <td>
                                <input type="number" name="labor_men_q6[]" id="labor_men_q6_1" value="0"
                                    class="form-control labor_men_q6" min="0">
                            </td>
                            <td>
                                <input type="number" name="labor_women_q6[]" id="labor_women_q6_1" value="0"
                                    class="form-control labor_women_q6" min="0">
                            </td>
                            <td><input type="number" name="labor_total_q6[]" id="labor_total_q6_1" value="0"
                                    class="form-control labor_total_q6" readonly></td>
                            <td><input type="text" name="labor_response_q6[]" class="form-control labor_response_q6">
                            </td>
                            <td>
                                <button type="button" class="btn btn-sm btn-primary"
