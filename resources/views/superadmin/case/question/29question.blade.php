    ...
    <div id="Question-29" class="collapse" role="tabpanel" aria-labelledby="heading-29" data-parent="#accordion-2">
        <div class="card-body">
            ...
            <div class="form-group mb-2">
                <input type="radio" id="radioYes29" class="twentyninestatus" name="is_adult_victims_juvenile_q29"
                    value="1" {{ (is_null($q29_checked) || $q29_checked === '1') ? 'checked' : '' }}>
                <label for="radioYes29" class="mr-3 font-weight-bold">Yes</label>

                <input type="radio" id="radioNo29" class="twentyninestatus" name="is_adult_victims_juvenile_q29"
                    value="0" {{ ($q29_checked === '0') ? 'checked' : '' }}>
                <label for="radioNo29" class="mr-3 font-weight-bold">No</label>

                <input type="radio" id="radioOthers29" class="twentyninestatus" name="is_adult_victims_juvenile_q29"
                    value="2" {{ ($q29_checked === '2') ? 'checked' : '' }}>
            ...
            <div id="yes_extra_q29"
                ...
                <input type="text" name="adult_victims_juvenile_title_q29" class="form-control mt-2 q29-yes-input"
                    placeholder="Please describe" value="{{ $yes_title_val }}">
            </div>
