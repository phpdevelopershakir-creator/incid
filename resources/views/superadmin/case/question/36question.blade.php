...
<div class="card question36">
    ...
    <div id="Question-36" class="collapse" role="tabpanel" aria-labelledby="heading-36">
        <div class="card-body">
            ...
            <form id="q36_form">
                @csrf
                <input type="hidden" name="question_no" value="36">
                        ...
                        <table class="table table-bordered table-striped" id="q36_dynamic_table">
                            ...
                            <tbody id="q36_table_body">
                                @for($i = 0; $i < $rowCount; $i++) <tr>
                                    <td>
                                        <select name="question36[q36_support_type][]"
                                            class="form-control q36_support_type">
                                    ...
                                    <td><input type="number" name="question36[q36_men][]"
                                            class="form-control q36_men q36_calc" min="0"
                                            value="{{ $q36_mens[$i] ?? 0 }}"></td>
                                    ...
                                    <td><input type="number" name="question36[q36_tg][]"
                                            class="form-control q36_tg q36_calc" min="0"
                                            value="{{ $q36_tgs[$i] ?? 0 }}"></td>
                                    <td><input type="number" name="question36[q36_total][]"
                                            class="form-control q36_row_total" value="{{ $q36_totals[$i] ?? 0 }}"
                                            readonly></td>
                                    <td>
                                        @if($i == 0)
