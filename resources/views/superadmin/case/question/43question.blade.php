    ...
    <div class="card question43">
        ...
        <div id="Question-43" class="collapse" role="tabpanel" aria-labelledby="heading-43" data-parent="#accordion-2">
            <div class="card-body">
                ...
                <input type="radio" id="radioYes43" class="fortythreestatus" name="is_civil_society_q43" value="1" 
                    {{ (is_null($q43_checked) || $q43_checked === '1') ? 'checked' : '' }}>
                <label for="radioYes43" class="mr-3">Yes</label>

                <input type="radio" id="radioNo43" class="fortythreestatus" name="is_civil_society_q43" value="0" 
                    {{ ($q43_checked === '0') ? 'checked' : '' }}>
                <label for="radioNo43" class="mr-3">No</label>

                <input type="radio" id="radioOthers43" class="fortythreestatus" name="is_civil_society_q43" value="2" 
                    {{ ($q43_checked === '2') ? 'checked' : '' }}>
                <label for="radioOthers43">Others</label>

                <!-- ইনলাইন স্টাইল দিয়ে ইনিশিয়াল হাইড/শো হ্যান্ডেল করা হয়েছে -->
                <div id="yes_extra_q43" style="display: {{ (is_null($q43_checked) || $q43_checked === '1') ? 'block' : 'none' }};">
                    <label class="mt-2 text-muted font-weight-bold">If "YES" please describe:</label>
                    <input type="text" name="yes_civil_society_desc_q43" class="form-control q43-yes-input"
                        placeholder="Provide Yes details"
                        value="{{ $q43_data['yes_desc'] ?? '' }}">
                </div>
                ...
                <div id="others_q43" style="display: {{ ($q43_checked === '2') ? 'block' : 'none' }};">
                    ...
                    <input type="text" name="others_civil_society_desc_q43" class="form-control q43-others-input" 
                        placeholder="Others details"
                        value="{{ $q43_data['others'] ?? '' }}">
                </div>
...
<script>
    $(document).ready(function() {
        ...
        function toggleq43() {
            let val = $("input[name='is_civil_society_q43']:checked").val();
...
<script>
    ...
    $(document).on("click", "#temp-save-question43", function() {
        let checkedValue = $("input[name='is_civil_society_q43']:checked").val();
        let q43_data = {};
