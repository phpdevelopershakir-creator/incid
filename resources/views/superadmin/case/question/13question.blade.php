    ...
    <div id="Question-13" class="collapse" role="tabpanel" aria-labelledby="heading-13" data-parent="#accordion-2">
        <div class="card-body">
            ...
            <div class="icheck-primary">
                <input type="radio" id="radioThirteen1" class="thirteen_status"
                    name="is_government_cooperate_foreign_counterparts_q13" value="1"
                    {{ $q13_checked == "1" ? "checked" : "" }}>
                <label for="radioThirteen1">Yes</label>
            </div>

            <div class="icheck-primary">
                <input type="radio" id="radioThirteen2" class="thirteen_status"
                    name="is_government_cooperate_foreign_counterparts_q13" value="0"
                    {{ $q13_checked == "0" ? "checked" : "" }}>
                <label for="radioThirteen2">No</label>
            </div>

            <div class="icheck-primary input-group mb-3">
                <input type="radio" id="radioThirteen3" class="thirteen_status"
                    name="is_government_cooperate_foreign_counterparts_q13" value="2"
                    {{ $q13_checked == "2" ? "checked" : "" }}>
                <label for="radioThirteen3">Others</label>
                <span class="col-md-6 mt--4 q13_others_container {{ $q13_checked == '2' ? '' : 'othersText' }}"
                    style="margin-top:-8px;">
                    <input type="text" id="q13others" placeholder="Please describe" class="form-control"
                        value="{{ $q13_others_val }}" name="other_government_cooperate_foreign_counterparts_q13">
                </span>
            </div>
                ...
                <table class="table table-bordered text-center q13-section-table" data-section="investigations">
                    ...
                    <tbody>
                        @for($i=0; $i<3; $i++) @php $row=$investigations_data[$i] ?? null;
                            $country=$row['government_country_q13a'] ??
                            ($row['government_cooperate_foreign_counterparts_country_q13a'] ?? '' );
                            $sex=$row['government_sex_q13a'] ??
                            ($row['government_cooperate_foreign_counterparts_sex_trafficking_q13a'] ?? 0);
                            $labour=$row['government_labour_q13a'] ??
                            ($row['government_cooperate_foreign_counterparts_labour_trafficking_q1'] ?? 0);
                            $other=$row['government_other_q13a'] ??
                            ($row['government_cooperate_foreign_counterparts_other_trafficking_q13'] ?? 0);
                            $total=$row['government_total_q13a'] ??
                            ($row['government_cooperate_foreign_counterparts_total_trafficking_q13'] ?? 0); @endphp <tr
                            class="investigations_q13_row">
                            <td><input type="text" name="government_country_q13a[]" class="form-control field-country"
                                    value="{{ $country }}"></td>
                            <td><input type="number" name="government_sex_q13a[]"
                                    class="form-control calc-input field-sex" value="{{ $sex }}" min="0"></td>
                            <td><input type="number" name="government_labour_q13a[]"
                                    class="form-control calc-input field-labour" value="{{ $labour }}" min="0"></td>
                            <td><input type="number" name="government_other_q13a[]"
                                    class="form-control calc-input field-other" value="{{ $other }}" min="0"></td>
                            <td><input type="text" name="government_total_q13a[]"
                ...
                <table class="table table-bordered text-center q13-section-table" data-section="prosecutions">
                    ...
                    <tbody>
                        @for($i=0; $i<3; $i++) @php $row=$prosecutions_data[$i] ?? null;
                            $country=$row['government_country_q13b'] ??
                            ($row['government_cooperate_foreign_counterparts_country_q13b'] ?? '' );
                            $sex=$row['government_sex_q13b'] ??
                            ($row['government_cooperate_foreign_counterparts_sex_trafficking_q13b'] ?? 0);
                            $labour=$row['government_labour_q13b'] ??
                            ($row['government_cooperate_foreign_counterparts_labour_trafficking_q1'] ?? 0);
                            $other=$row['government_other_q13b'] ??
                            ($row['government_cooperate_foreign_counterparts_other_trafficking_q13'] ?? 0);
                            $total=$row['government_total_q13b'] ??
                            ($row['government_cooperate_foreign_counterparts_total_trafficking_q13'] ?? 0); @endphp <tr
                            class="prosecutions_q13_row">
                            <td><input type="text" name="government_country_q13b[]" class="form-control field-country"
                                    value="{{ $country }}"></td>
                            <td><input type="number" name="government_sex_q13b[]"
                                    class="form-control calc-input field-sex" value="{{ $sex }}" min="0"></td>
                            <td><input type="number" name="government_labour_q13b[]"
                                    class="form-control calc-input field-labour" value="{{ $labour }}" min="0"></td>
                            <td><input type="number" name="government_other_q13b[]"
                                    class="form-control calc-input field-other" value="{{ $other }}" min="0"></td>
                            <td><input type="text" name="government_total_q13b[]"
                                    class="form-control total-input field-total" value="{{ $total }}" readonly></td>
                            </tr>
                            @endfor
                    </tbody>
                ...
                <table class="table table-bordered text-center q13-section-table" data-section="repatriations">
                    ...
                    <tbody>
                        @for($i=0; $i<3; $i++) @php $row=$repatriations_data[$i] ?? null;
                            $country=$row['government_country_q13c'] ??
                            ($row['government_cooperate_foreign_counterparts_country_q13c'] ?? '' );
                            $sex=$row['government_sex_q13c'] ??
                            ($row['government_cooperate_foreign_counterparts_sex_trafficking_q13c'] ?? 0);
                            $labour=$row['government_labour_q13c'] ??
                            ($row['government_cooperate_foreign_counterparts_labour_trafficking_q1'] ?? 0);
                            $other=$row['government_other_q13c'] ??
                            ($row['government_cooperate_foreign_counterparts_other_trafficking_q13'] ?? 0);
                            $total=$row['government_total_q13c'] ??
                            ($row['government_cooperate_foreign_counterparts_total_trafficking_q13'] ?? 0); @endphp <tr
                            class="repatriations_q13_row">
                            <td><input type="text" name="government_country_q13c[]" class="form-control field-country"
                                    value="{{ $country }}"></td>
                            <td><input type="number" name="government_sex_q13c[]"
                                    class="form-control calc-input field-sex" value="{{ $sex }}" min="0"></td>
                            <td><input type="number" name="government_labour_q13c[]"
                                    class="form-control calc-input field-labour" value="{{ $labour }}" min="0"></td>
                            <td><input type="number" name="government_other_q13c[]"
                                    class="form-control calc-input field-other" value="{{ $other }}" min="0"></td>
                            <td><input type="text" name="government_total_q13c[]"
                                    class="form-control total-input field-total" value="{{ $total }}" readonly></td>
                            </tr>
                            @endfor
                    </tbody>
                ...
                <table class="table table-bordered text-center q13-section-table" data-section="extraditions">
                    ...
                    <tbody>
                        @for($i=0; $i<3; $i++) @php $row=$extraditions_data[$i] ?? null;
                            $country=$row['government_country_q13d'] ??
                            ($row['government_cooperate_foreign_counterparts_country_q13d'] ?? '' );
                            $sex=$row['government_sex_q13d'] ??
                            ($row['government_cooperate_foreign_counterparts_sex_trafficking_q13d'] ?? 0);
                            $labour=$row['government_labour_q13d'] ??
                            ($row['government_cooperate_foreign_counterparts_labour_trafficking_q1'] ?? 0);
                            $other=$row['government_other_q13d'] ??
                            ($row['government_cooperate_foreign_counterparts_other_trafficking_q13'] ?? 0);
                            $total=$row['government_total_q13d'] ??
                            ($row['government_cooperate_foreign_counterparts_total_trafficking_q13'] ?? 0); @endphp <tr
                            class="extraditions_q13_row">
                            <td><input type="text" name="government_country_q13d[]" class="form-control field-country"
                                    value="{{ $country }}"></td>
                            <td><input type="number" name="government_sex_q13d[]"
                                    class="form-control calc-input field-sex" value="{{ $sex }}" min="0"></td>
                            <td><input type="number" name="government_labour_q13d[]"
                                    class="form-control calc-input field-labour" value="{{ $labour }}" min="0"></td>
                            <td><input type="number" name="government_other_q13d[]"
                                    class="form-control calc-input field-other" value="{{ $other }}" min="0"></td>
                            <td><input type="text" name="government_total_q13d[]"
                                    class="form-control total-input field-total" value="{{ $total }}" readonly></td>
                            </tr>
                            @endfor
                    </tbody>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.thirteen_status', function() {
        var statusvalue = $("input[name='is_government_cooperate_foreign_counterparts_q13']:checked")
            .val();
        if (statusvalue == '1') {
    ...
    $(document).on('click', '#temp-save-question13', function(e) {
        ...
        let yes_no_value = $("input[name='is_government_cooperate_foreign_counterparts_q13']:checked")
            .val();
