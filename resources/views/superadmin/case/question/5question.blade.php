    ...
    <div id="Question-5" class="collapse" role="tabpane5" aria-labelledby="heading-4" data-parent="#accordion-2">
        <div class="card-body">
            ...
            <div id="others_q5" style="display: {{ ($q5_checked === '2') ? 'block' : 'none' }};">
                <input type="text" name="others_complicit_official_q5" class="form-control mt-2 q5-others-input"
                    placeholder="Please describe" value="{{ $q5_data['others'] ?? '' }}">
            </div>

            <div id="yes_extra_q5"
                style="display: {{ (is_null($q5_checked) || $q5_checked === '1') ? 'block' : 'none' }};">
                <input type="text" name="involved_directly_trafficking_title_q5" class="form-control mt-2 q5-yes-input"
                    placeholder="Please describe" value="{{ $q5_data['involved_directly_trafficking_title'] ?? '' }}">
            </div>
