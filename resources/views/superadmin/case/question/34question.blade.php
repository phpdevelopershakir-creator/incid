...
// (Victims participated in Investigation)
$part1 = $question_34_data['part1_data'] ?? [];
$p1_men = $part1['men'] ?? 0;
$p1_women = $part1['women'] ?? 0;
$p1_boy = $part1['boy'] ?? 0;
$p1_girl = $part1['girl'] ?? 0;
$p1_tg = $part1['tg'] ?? 0;
        ...
        <div class="card-body">
            ...
            <div class="icheck-primary input-group mb-3">
                ...
                <span class="col-md-6 mt--4 others_input_container {{ $q34_checked == "2" ? '' : 'othersText' }}">
                    <input type="text" id="q34_others_input" class="form-control" placeholder="Please describe"
                ...
                <table class="table table-bordered text-center mb-4">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th style="width: 18%;">Boy</th>
                            <th style="width: 18%;">Girl</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="number" id="p1_men" name="men_victims_q34" class="form-control p1_calc"
                                    value="{{ $p1_men }}" min="0">
                            </td>
                            <td>
                                <input type="number" id="p1_women" name="women_victims_q34" class="form-control p1_calc"
                                    value="{{ $p1_women }}" min="0">
                            </td>
                            <td>
                                <input type="number" id="p1_boy" name="boy_victims_q34" class="form-control p1_calc"
                                    value="{{ $p1_boy}}" min="0">
                            </td>

                            <td>
                                <input type="number" id="p1_girl" name="girl_victims_q34" class="form-control p1_calc"
                                    value="{{ $p1_girl}}" min="0">
                            </td>

                            <td>
                                <input type="number" id="p1_tg" name="tg_victims_q34" class="form-control p1_calc"
                                    value="{{ $p1_tg }}" min="0">
                            </td>
                            <td>
                                <input type="number" id="p1_total" name="total_victims_q34" class="form-control"
                ...
                <table id="q34_support_table" class="table table-bordered text-center">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th colspan="6">Number of VoTs receiving support</th>
                            <th rowspan="2" style="vertical-align: middle; width: 10%;">Add row</th>
                        </tr>
                        <tr class="bg-light">
                            <th>Men</th>
                            <th>Women</th>
                        ...
                        <tr class="q34_p2_row" id="q34_p2_row_{{ $i+1 }}">
                            <td>
                                <select class="form-control p2_support_type" name="number_victims_q34b[]">
                                    <option value="" disabled {{ empty($row['type']) ? 'selected' : '' }}>Choose an
                                        item.</option>
                            ...
                            <td><input type="number" name="boy_victims_q34b[]" class="form-control p2_boy p2_calc"
                                    value="{{ $row['boy'] ?? 0 }}" min="0"></td>

                            <td><input type="number" name="girl_victims_q34b[]" class="form-control p2_girl p2_calc"
                            ...
                            <td>
                                ...
                                @else
                                <button type="button" class="btn btn-sm btn-danger remove_q34_p2_row"
                                    data-id="{{ $i+1 }}">-</button>
                                @endif
                            </td>
                        </tr>
...
$(document).ready(function() {
    ...
    $(document).on("input change keyup", ".p1_calc", function() {
        ...
        let boy = parseInt($("#p1_boy").val()) || 0;
        let girl = parseInt($("#p1_girl").val()) || 0;
        let tg = parseInt($("#p1_tg").val()) || 0;

        $("#p1_total").val(men + women + tg + boy + girl);
    });
    ...
    $(document).on("input change keyup", ".p2_calc", function() {
        ...
        let boy = parseInt(row.find(".p2_boy").val()) || 0;
        let girl = parseInt(row.find(".p2_girl").val()) || 0;
    ...
    $("#add_q34_p2_row").click(function() {
        ...
        $("#q34_support_table tbody").append(`
            <tr class="q34_p2_row" id="q34_p2_row_${rowId}">
                ...
                <td><input type="number" name="boy_victims_q34b[]" class="form-control p2_boy p2_calc" value="0" min="0"></td>
                <td><input type="number" name="girl_victims_q34b[]" class="form-control p2_girl p2_calc" value="0" min="0"></td>
    ...
    $("#temp-save-question34").click(function() {
        ...
        $(".q34_p2_row").each(function() {
            ...
            let boy = $(this).find(".p2_boy").val() || 0;
            let girl = $(this).find(".p2_girl").val() || 0;
