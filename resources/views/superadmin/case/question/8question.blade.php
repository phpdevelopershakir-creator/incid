    ...
    <div id="Question-8" class="collapse" role="tabpane8" aria-labelledby="heading-8" data-parent="#accordion-2">
        <div class="card-body">
            ...
            <div class="icheck-primary">
                <input type="radio" id="q8radioPrimary1" class="eight_status" name="is_involved_directly_trafficking_8q"
                    value="1" {{ $q8_checked == "1" ? "checked" : "" }}>
                <label for="q8radioPrimary1">Yes</label>
            </div>

            <!-- NO -->
            <div class="icheck-primary">
                <input type="radio" id="q8radioPrimary2" class="eight_status" name="is_involved_directly_trafficking_8q"
                    value="0" {{ $q8_checked == "0" ? "checked" : "" }}>
                <label for="q8radioPrimary2">No</label>
            </div>

            <!-- OTHERS -->
            <div class="icheck-primary input-group mb-3">
                <input type="radio" id="q8radioPrimary3" class="eight_status" name="is_involved_directly_trafficking_8q"
                    value="2" {{ $q8_checked == "2" ? "checked" : "" }}>
                <label for="q8radioPrimary3">Others</label>

                <span class="col-md-6 mt--4 q8_others_container {{ $q8_checked == '2' ? '' : 'othersText' }}"
                    style="margin-top:-8px;">
                    <input type="text" id="q8others" placeholder="Please describe" class="form-control"
                        ...
                        @for ($i = 1; $i <= 4; $i++) <tr>
                            ...
                            <td>
                                <input type="number" name="official_investigation_q8[]" id="q8Men{{ $i }}" min="0"
                                    class="form-control question8RowMen q8Input"
                                    value="{{ $q8_table_data['q8Men' . $i] ?? 0 }}">
                            </td>
                            <td>
                                <input type="number" name="official_prosecution_q8[]" id="q8Women{{ $i }}" min="0"
                                    class="form-control question8RowWomen q8Input"
                                    value="{{ $q8_table_data['q8Women' . $i] ?? 0 }}">
                            </td>
                            <td>
                                <input type="number" name="official_conviction_q8[]" id="q8Boy{{ $i }}" min="0"
                                    class="form-control question8RowBoys q8Input"
                                    value="{{ $q8_table_data['q8Boy' . $i] ?? 0 }}">
                            </td>
                            <td>
                                <input type="number" name="official_administrative_q8[]" id="q8Girl{{ $i }}" min="0"
                                    class="form-control question8RowGirls q8Input"
                            ...
                            <tr>
                                <th>Total</th>
                                <td><input type="number" id="q8MenTotal" class="form-control q8gTotal q8Input" readonly>
                                </td>
                                <td><input type="number" id="q8WomenTotal" class="form-control q8gTotal q8Input"
                                        readonly></td>
                                <td><input type="number" id="q8BoysTotal" class="form-control q8gTotal q8Input"
                                        readonly></td>
                                <td><input type="number" id="q8GirlsTotal" class="form-control q8gTotal q8Input"
                                        readonly></td>
                            </tr>
                    </tbody>
                </table>
