...
<style type="text/css">
    ...
    th { font-size: 13px }
    td { font-size: 13px }
    .q37-table table th.row_cell, .q37-table table td.row_cell {
        border: 1px solid #000;
    }
    .heading {
        background:'#28a745';
...
<body>
<div class="q37-table-chart">
  <!-- <div class="card card-outline collapsed-card">
    <div class="card-header">
      <h3 class="card-title">37.Did the government train its diplomats not to engage in or facilitate
        trafficking?
      </h3> -->
        <div class="q37-table">
    
            <table class="table table-bordered" id="q37_individual_activities">
                <thead>
                    <tr>
      ...
      <br><br>
      <div class="q37-table">
            <table class="table table-bordered" id="q37_all_participants">
                <thead>
                    <tr>
                    <th rowspan="2" class="row_cell">Type of TIP Cases investigated</th>  
                    <th rowspan="2" class="row_cell">Category of coverage</th>              
