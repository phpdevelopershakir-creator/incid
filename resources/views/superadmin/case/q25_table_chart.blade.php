...
<style type="text/css">
    ...
    th { font-size: 13px }
    td { font-size: 13px }
    .q25-table table th.row_cell, .q25-table table td.row_cell {
        border: 1px solid #000;
    }
    .heading {
        background:'#28a745';
...
<body>
<div class="q25-table-chart">
  <!-- <div class="card card-outline collapsed-card">
    <div class="card-header">
      <h3 class="card-title">25.Did the government train its diplomats not to engage in or facilitate
        trafficking?
      </h3> -->
        <div class="q25-table">
    
            <table class="table table-bordered" id="q25_individual_activities">
                <thead>
                    <tr>
                        <th rowspan="2" class="row_cell">Protection Services</th>
                        <th rowspan="2" class="row_cell">Status</th>
      ...
      <br><br>
      <div class="q25-table">
            <table class="table table-bordered" id="q25_all_participants">
                <thead>
                    <tr>
                    <th rowspan="2" class="row_cell">Protection Services</th>
                    <th rowspan="2" class="row_cell">Status</th>
