        ...
        <div class="card-body">
            ...
            <div id="24_question_view" class="<?= ($q30_checked == '0' || $q30_checked == '2') ? 'visibility' : ''; ?>">
                <table id="addRowq30" class="table table-bordered text-center">
                    ...
                    <tbody>
                        <?php 
                        // যদি পূর্বে সেভ করা সেশন ডাটা থাকে
                        ...
                        <tr class="qe24NoOfRow" id="row_old_<?= $i; ?>">
                            <td>
                                ...
                                <input type="text" name="citizen_victims_services_q30[]" class="form-control"
                                    value="<?= htmlspecialchars($service_val) ?>" placeholder="Other (Specify)">
                                <?php } ?>
                            </td>
                            <td>
                        ...
                        <?php 
                            ...
                            // প্রথমবার পেজ লোড হলে টোটাল ফিক্সড ১৮টি রো রেন্ডার হবে (১৫টি ড্রপডাউন + ৩টি আদার্স)
                            
                            // ১ থেকে ১৫ নম্বর ড্রপডাউন রো
                        ...
                        <tr class="qe24NoOfRow" id="row_fixed_<?= $key ?>">
                            ...
                            <td></td> <!-- ফিক্সড রো-তে কোনো রিমুভ/অ্যাড বাটন নেই -->
                        </tr>
                        <?php 
                            } 
                            
                            // ১৬ ও ১৭ নম্বর রো (১ম এবং ২য় আদার্স ফিল্ড - অ্যাকশন বাটন ছাড়া)
                            for ($idx = 1; $idx <= 2; $idx++) {
                        ?>
                        ...
                        <?php 
                            ...
                            // ১৮ নম্বর রো (৩য় আদার্স ফিল্ড - যেখানে অ্যাড মোর (+) বাটন থাকবে)
                        ?>
...
$(function() {
    ...
    // অ্যাড মোর বাটনে ক্লিক করলে নতুন ডায়নামিক Other রো তৈরি হবে
    $(document).on('click', '.addRowDatasq30', function() {
        ...
        <tr class="qe24NoOfRow" id="row_${uniqueId}">
            <td>
                <input type="text" name="citizen_victims_services_q30[]" class="form-control" placeholder="Other (Specify)">
            </td>
            <td>
               <select name="citizen_victims_quality_q30[]" class="form-control q30Input">
                    ${qualityOptions}
    ...
    // ডায়নামিক রো রিমুভ করার হ্যান্ডলার
    ...
    $(document).on('click', '#temp-save-question30', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                alert("Question 30  saved successfully! ");
            },
            error: function(xhr) {
