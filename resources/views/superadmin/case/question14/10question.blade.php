...
if (($questiontitles[9]->status ?? null) == 1) {
    // সেশন থেকে Question 10 এর ডেটা রিসিভ করা হচ্ছে (ঠিক যেমনটা ৯ নম্বরে ছিল)
    ...
    // অবজেক্টকে অ্যারেতে কনভার্ট করা (নিরাপত্তার জন্য)
        ...
        <div id="Question-10" class="collapse" role="tabpanel" aria-labelledby="heading-10" data-parent="#accordion-2">
            <div class="card-body">
                ...
                <div class="icheck-primary">
                    <input type="radio" id="radioTen1" class="tenstatus" name="is_exclusively_trafficking_q10" value="1" <?= ($q10_checked == "1") ? "checked" : ""; ?>>
                    <label for="radioTen1">Yes</label>
                </div>

                <div class="icheck-primary">
                    <input type="radio" id="radioTen2" class="tenstatus" name="is_exclusively_trafficking_q10" value="0" <?= ($q10_checked == "0") ? "checked" : ""; ?>>
                    <label for="radioTen2">No</label>
                </div>

                <div class="icheck-primary input-group">
                    <input type="radio" id="radioTen3" class="tenstatus" name="is_exclusively_trafficking_q10" value="2" <?= ($q10_checked == "2") ? "checked" : ""; ?>>
                    <label for="radioTen3">Others</label>
                    <span class="col-md-6 mt--4 <?= ($q10_checked == "2") ? "" : "othersText"; ?>">
                        <input type="text" id="q10others" placeholder="Others Specific" class="form-control" value="<?= $q10_others_val; ?>" name="other_exclusively_trafficking_q10">
                    </span>
                </div>

                <div id="ten_question_view" class="<?= ($q10_checked == "2" || $q10_checked == "0") ? "visibility" : ""; ?>">
                    <br>
                        ...
                        <tbody>
                                ...
                                <tr class="qe10NoOfRow">
                                    ...
                                    <td>
                                        <div class="radio-group-vertical">
                                            <label><input type="radio" name="<?= $key; ?>_radio_q10" value="1" onchange="setCourtTypeQ10(this)" <?= $has_value ? 'checked' : ''; ?>> Yes</label>
                                            <label><input type="radio" name="<?= $key; ?>_radio_q10" value="0" onchange="setCourtTypeQ10(this)" <?= !$has_value ? 'checked' : ''; ?>> No</label>
                                            <input type="hidden" name="court_type_q10[]" class="courtTypeHolder10" value="<?= $has_value ? '1' : '0'; ?>">
                                        </div>
                                    </td>
                                    <td>
                                        <input type="text" name="court_description_q10[]" class="form-control desc-td" style="display: <?= $has_value ? 'block' : 'none'; ?>;" value="<?= $saved_desc; ?>">
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                            <?php } ?>
                            ...
                            <?php if (!empty($q10_other_rows) && (is_array($q10_other_rows) || is_object($q10_other_rows))) { ?>
                                ...
                                <tr class="qe10NoOfRowOthers" id="row_q10_{{$index}}">
                                    <td>
                                        <input type="text" name="court_title_q10[]" class="form-control" value="{{ $oth_title }}" placeholder="Others Specific">
                                    </td>
                                    <td>
                                        <div class="radio-group-vertical">
                                            <label><input type="radio" name="dynamic_radio_q10_{{$index}}" value="1" onchange="setCourtTypeQ10(this)" {{ $oth_has_val ? 'checked' : '' }}> Yes</label>
                                            <label><input type="radio" name="dynamic_radio_q10_{{$index}}" value="0" onchange="setCourtTypeQ10(this)" {{ !$oth_has_val ? 'checked' : '' }}> No</label>
                                            <input type="hidden" name="court_type_q10[]" class="courtTypeHolder10" value="{{ $oth_has_val ? '1' : '0' }}">
                                        </div>
                                    </td>
                                    <td>
                                        <input type="text" name="court_description_q10[]" value="{{ $oth_desc }}" class="form-control desc-td" style="display: {{ $oth_has_val ? 'block' : 'none' }};">
                                    </td>
                                    <td>
                                        @if($loop->first)
                            ...
                            <?php } else { ?>
                                <tr class="qe10NoOfRowOthers">
                                    <td>
                                        <input type="text" name="court_title_q10[]" class="form-control" placeholder="Others Specific">
                                    </td>
                                    <td>
                                        <div class="radio-group-vertical">
                                            <label><input type="radio" name="dynamic_radio_q10_0" value="1" onchange="setCourtTypeQ10(this)"> Yes</label>
                                            <label><input type="radio" name="dynamic_radio_q10_0" value="0" onchange="setCourtTypeQ10(this)" checked> No</label>
        ...
        $(document).on("click", '#temp-save-question10', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) { // কন্ট্রোলারের ['success' => true] রেসপন্স চেক করা হচ্ছে
