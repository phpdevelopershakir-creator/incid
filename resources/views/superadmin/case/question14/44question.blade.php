...
?>
    ...
    <div id="Question-44" class="collapse" role="tabpanel" aria-labelledby="heading-44" data-parent="#accordion-2">
      <div class="card-body">
        ...
        <div class="icheck-primary">
          <input type="radio" id="radioFoutyFour1" class="fourtyfour_status" name="is_awareness_campaigns_research_projects_q44" value="1" {{ $q44_checked == "1" ? "checked" : "" }}>
          <label for="radioFoutyFour1">Yes</label>
        </div>

        <div class="icheck-primary">
          <input type="radio" id="radioFourtyFour2" class="fourtyfour_status" name="is_awareness_campaigns_research_projects_q44" value="0" {{ $q44_checked == "0" ? "checked" : "" }}>
          <label for="radioFourtyFour2">No</label>
        </div>

        <div class="icheck-primary input-group mb-3">
          <input type="radio" id="radioFourtyFour3" class="fourtyfour_status" name="is_awareness_campaigns_research_projects_q44" value="2" {{ $q44_checked == "2" ? "checked" : "" }}>
          <label for="radioFourtyFour3">Others</label>

          <span class="col-md-6 mt--4 q44_others_container {{ $q44_checked == '2' ? '' : 'othersText' }}">
            <input type="text" id="q44others" placeholder="Others Specific" class="form-control" value="{{ $q44_others_val }}" name="other_awareness_campaigns_research_projects_q44">
          </span>
        </div>

        <div id="fourtyfour_question_view" class="{{ ($q44_checked == '2' || $q44_checked == '0') ? 'visibility' : '' }}">
          <table class="table table-white table-bordered">
            ...
            <tbody>
              ...
              <tr class="q44_row" data-title-id="1">
                ...
                <td>
                  <input type="text" name="awareness_campaigns_research_projects_status_q44[]" class="form-control q44_input_field" value="{{ $q44_table_data[1] ?? '' }}">
                </td>
              </tr>
              ...
              <tr class="q44_row" data-title-id="2">
                ...
                <td>
                  <input type="text" name="awareness_campaigns_research_projects_status_q44[]" class="form-control q44_input_field" value="{{ $q44_table_data[2] ?? '' }}">
                </td>
              </tr>
              ...
              <tr class="q44_row" data-title-id="3">
                ...
                <td>
                  <input type="text" name="awareness_campaigns_research_projects_status_q44[]" class="form-control q44_input_field" value="{{ $q44_table_data[3] ?? '' }}">
                </td>
              </tr>
              ...
              <tr class="q44_row" data-title-id="4">
                ...
                <td>
                  <input type="text" name="awareness_campaigns_research_projects_status_q44[]" class="form-control q44_input_field" value="{{ $q44_table_data[4] ?? '' }}">
                </td>
              </tr>
              ...
              <tr class="q44_row" data-title-id="5">
                ...
                <td>
                  <input type="text" name="awareness_campaigns_research_projects_status_q44[]" class="form-control q44_input_field" value="{{ $q44_table_data[5] ?? '' }}">
                </td>
              </tr>
              ...
              <tr class="q44_row" data-title-id="6">
                ...
                <td>
                  <select name="awareness_campaigns_research_projects_status_q44[]" id="q44Description" class="form-control q44_input_field">
                    <option value="" disabled selected>---Choose an item--</option>
                    <?php foreach ($q44_status as $key => $item) { ?>
                      <option value="<?= $key ?>" <?= (($q44_table_data[6] ?? '') == $key) ? 'selected' : '' ?>><?= $item ?></option>
                    <?php } ?>
                  </select>
                </td>
              </tr>
  ...
  <script>
    $(document).ready(function() {
      ...
      // 💾 ড্রাফট সেভ সাবমিশন স্ক্রিপ্ট
      $(document).on("click", '#temp-save-question44', function() {
        let yes_no_value = $("input[name='is_awareness_campaigns_research_projects_q44']:checked").val();
        let table_data = {};

        // টেবিলের ৬টি রো-এর ডাটা ডাইনামিক কি-অ্যাসোসিয়েশনে লুপ করা
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            alert("Question 44 Draft Saved Temporarily ✅");
          },
          error: function(err) {
