    ...
    <div id="Question-46" class="collapse" role="tabpanel" aria-labelledby="heading-46" data-parent="#accordion-46">
      <div class="card-body">
        ...
        <div class="icheck-primary">
          <input type="radio" id="radioFortySix1" class="fortysix_status" name="is_government_conduct_awareness_activities_q46" <?= ($q46_checked == '1') ? 'checked' : ''; ?> value="1">
          <label for="radioFortySix1">Yes</label>
        </div>

        <div class="icheck-primary">
          <input type="radio" id="radioFortySix2" class="fortysix_status" name="is_government_conduct_awareness_activities_q46" <?= ($q46_checked == '0') ? 'checked' : ''; ?> value="0">
          <label for="radioFortySix2">No</label>
        </div>

        <div class="icheck-primary input-group mb-3">
          <input type="radio" id="radioFortySix3" class="fortysix_status" name="is_government_conduct_awareness_activities_q46" <?= ($q46_checked == '2') ? 'checked' : ''; ?> value="2">
          <label for="radioFortySix3">Others</label>
          <span class="col-md-6 style-input <?= ($q46_checked == '2') ? '' : 'othersText'; ?>" id="q46_others_spec_wrapper" style="margin-top:-8px; margin-left: 10px;">
            <input type="text" id="q46others" placeholder="Others" class="form-control" value="<?= $q46_others_val; ?>" name="other_government_conduct_awareness_activities_q46">
          </span>
        </div>
            ...
            <table id="addRowQ46Internal" class="table table-bordered text-center table-sm">
              <thead>
                <tr>
                  ...
                  <th rowspan="2" style="text-align: center; vertical-align: middle; min-width: 50px;">Action</th>
                </tr>
                <tr>
                  <th>M</th>
                  <th>W</th>
              ...
              <tbody id="q46_table_body">
                ...
                ?>
                    <tr class="q46Row">
                      <td>
                        <?php if ($is_fixed_row) { ?>
                          <span class="font-weight-normal"><?= $activities_list[$q46A->type_activity] ?></span>
                          <input type="hidden" name="q46_type_activity[]" value="<?= $q46A->type_activity ?>">
                        <?php } else { ?>
                          <input type="text" value="<?= $q46A->type_activity ?? '' ?>" name="q46_type_activity[]" class="form-control text-danger font-weight-bold" placeholder="Others (Specify)">
                        <?php } ?>
                      </td>
                      <td><input type="number" value="<?= $q46A->comm_m ?? 0 ?>" name="q46_comm_m[]" class="form-control calculate-total q46_men" min="0"></td>
                      <td><input type="number" value="<?= $q46A->comm_w ?? 0 ?>" name="q46_comm_w[]" class="form-control calculate-total q46_women" min="0"></td>
                      <td><input type="number" value="<?= $q46A->comm_tg ?? 0 ?>" name="q46_comm_tg[]" class="form-control calculate-total q46_third_gender" min="0"></td>
                      <td><input type="number" value="<?= $q46A->comm_b ?? 0 ?>" name="q46_comm_b[]" class="form-control calculate-total q46_boys" min="0"></td>
                      <td><input type="number" value="<?= $q46A->comm_g ?? 0 ?>" name="q46_comm_g[]" class="form-control calculate-total q46_girls" min="0"></td>
                      <td><input type="text" value="<?= $q46A->comm_t ?? 0 ?>" name="q46_comm_t[]" class="form-control q46_comm_total" readonly></td>

                      <td><input type="number" value="<?= $q46A->org_go ?? 0 ?>" name="q46_org_go[]" class="form-control" min="0"></td>
                      <td><input type="number" value="<?= $q46A->org_ngo ?? 0 ?>" name="q46_org_ngo[]" class="form-control" min="0"></td>
                      <td><input type="number" value="<?= $q46A->org_ingo ?? 0 ?>" name="q46_org_ingo[]" class="form-control" min="0"></td>
                      <td><input type="number" value="<?= $q46A->org_un ?? 0 ?>" name="q46_org_un[]" class="form-control" min="0"></td>
                      <td><input type="number" value="<?= $q46A->org_ctc ?? 0 ?>" name="q46_org_ctc[]" class="form-control" min="0"></td>
                      <td><input type="number" value="<?= $q46A->org_others ?? 0 ?>" name="q46_org_others[]" class="form-control" min="0"></td>

                      <td><input type="number" value="<?= $q46A->total_m ?? 0 ?>" name="q46_total_m[]" class="form-control q46_total_m" min="0"></td>
                      <td><input type="number" value="<?= $q46A->total_f ?? 0 ?>" name="q46_total_f[]" class="form-control q46_total_f" min="0"></td>
                      <td><input type="text" value="<?= $q46A->total_t ?? 0 ?>" name="q46_total_t[]" class="form-control q46_total" readonly></td>
                  ...
                  <tr class="q46Row" id="base_others_row">
                    <td>
                      <input type="text" name="q46_type_activity[]" class="form-control  font-weight-bold" placeholder="Others (Specify)">
                    </td>
                    <td><input type="number" name="q46_comm_m[]" class="form-control calculate-total q46_men" value="0" min="0"></td>
                    <td><input type="number" name="q46_comm_w[]" class="form-control calculate-total q46_women" value="0" min="0"></td>
                    <td><input type="number" name="q46_comm_tg[]" class="form-control calculate-total q46_third_gender" value="0" min="0"></td>
                    ...
                    <td>
                      <button type="button" id="add_more_q46_btn" class="btn btn-sm btn-primary btn-xs"><i class="fa fa-plus"></i></button>
                    </td>
                  </tr>
                <?php } ?>
...
<script>
  $(document).ready(function() {
    ...
    // Dynamic Row injection (Inserts right after the active target row)
    $('#add_more_q46_btn').click(function() {
      var html = `<tr class="q46Row generated-row">
        <td><input type="text" name="q46_type_activity[]" class="form-control font-weight-bold" placeholder="Others (Specify)"></td>
        <td><input type="number" name="q46_comm_m[]" class="form-control calculate-total q46_men" value="0" min="0"></td>
        <td><input type="number" name="q46_comm_w[]" class="form-control calculate-total q46_women" value="0" min="0"></td>
        <td><input type="number" name="q46_comm_tg[]" class="form-control calculate-total q46_third_gender" value="0" min="0"></td>
        <td><input type="number" name="q46_comm_b[]" class="form-control calculate-total q46_boys" value="0" min="0"></td>
      ...
      // Base others row er thik niche insert hobe
    ...
    // Ajax Temp Save handler
    $('#temp-save-question46').click(function(e) {
      e.preventDefault();

      let checked_value = $("input[name='is_government_conduct_awareness_activities_q46']:checked").val() || "1";
      ...
      $('.q46Row').each(function() {
        ...
        if (type_act !== "") {
          activityDataSet.push({
            ...
            org_others: $(this).find('input[name^="q46_org_others"]').val() || 0,
      ...
      $.ajax({
        ...
        success: function(response) {
          if (response.success) {
            ...
            alert('Question 46 data saved properly!');
          } else {
