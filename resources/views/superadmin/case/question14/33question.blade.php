    ...
    <div class="card question33">
        ...
        <div id="Question-33" class="collapse" role="tabpane33" aria-labelledby="heading-32" data-parent="#accordion-2">
            <div class="card-body">
                ...
                <!-- Yes এর জন্য ইনপুট ফিল্ড -->
                <div id="yes_extra_q33" style="display: {{ (is_null($q33_checked) || $q33_checked === '1') ? 'block' : 'none' }};">
                    <input type="text" name="involved_directly_trafficking_title_q33" class="form-control mt-2 q33-yes-input"
                        placeholder="Provide Yes details"
                        value="{{ $q33_data['involved_directly_trafficking_title'] ?? '' }}">
                </div>

                <!-- No এর জন্য ইনপুট ফিল্ড -->
                <div id="no_extra_q33" style="display: {{ ($q33_checked === '0') ? 'block' : 'none' }};">
                    <input type="text" name="no_details_q33" class="form-control mt-2 q33-no-input"
                        ...
                        value="{{ $q33_data['no_details'] ?? '' }}">
                </div>

                <!-- Others এর জন্য ইনপুট ফিল্ড -->
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    alert("Question 33 has been saved temporarily");
                } else {
                    alert("Not Saved");
                }
            },
