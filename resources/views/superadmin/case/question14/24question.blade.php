...
if (($questiontitles[23]->status ?? null) == 1) {
    // সেশন থেকে Question 24 এর ডাটা রিসিভ করা হচ্ছে
    $question_24_data = session()->get('question24');

    // ডাটা অবজেক্ট বা অ্যারে যাই হোক না কেন, তা হ্যান্ডেল করার সহজ উপায়
...
?>
    ...
    <div id="Question-24" class="collapse" role="tabpane24" aria-labelledby="heading-4" data-parent="#accordion-2">
      <div class="card-body">
        ...
        <div class="icheck-primary">
          <input type="radio" id="radioTwentyFour1" class="twentyfourstatus" name="is_specialized_trafficking_victims_q24" value="1" <?= ($q24_checked == "1") ? "checked" : ""; ?>>
          <label for="radioTwentyFour1">Yes</label>
        </div>
        <div class="icheck-primary">
          <input type="radio" id="radioTwentyFour2" class="twentyfourstatus" name="is_specialized_trafficking_victims_q24" value="0" <?= ($q24_checked == "0") ? "checked" : ""; ?>>
          <label for="radioTwentyFour2">No</label>
        </div>
        <div class="icheck-primary input-group">
          <input type="radio" id="radioTwentyFour3" class="twentyfourstatus" name="is_specialized_trafficking_victims_q24" value="2" <?= ($q24_checked == "2") ? "checked" : ""; ?>>
          <label for="radioTwentyFour3">Others</label>
          <span class="col-md-6 mt--4 <?= ($q24_checked == "2") ? "" : "othersText"; ?>">
            <input type="text" id="q24others" placeholder="Others " class="form-control" value="<?= $q24_others_val; ?>" name="other_specialized_trafficking_victims_q24">
          </span>
        </div>
          ...
          <table id="addRowQ24" class="table table-bordered text-center">
            ...
            <tbody>
              ...
              ?>
                ...
                @php
                  $saved_locations = json_decode(json_encode($q24->specialized_trafficking_victims_location_q24 ?? ($q24['specialized_trafficking_victims_location_q24'] ?? [])), true);
                ...
                <tr class="qe24NoOfRow" id="row_old_<?= $i; ?>">
                  <td>
                    <select name="specialized_trafficking_victims_protection_q24[]" class="form-control q24Input">
                      ...
                      <option <?= (isset($q24->specialized_trafficking_victims_protection_q24) && $q24->specialized_trafficking_victims_protection_q24 == $key) || (isset($q24['specialized_trafficking_victims_protection_q24']) && $q24['specialized_trafficking_victims_protection_q24'] == $key) ? 'selected' : ''; ?> value="{{ $key }}">{{ $training }}</option>
                      @endforeach
                    </select>
                  </td>
                  <td>
                    <select name="specialized_trafficking_victims_quality_q24[]" class="form-control q24Input">
                      ...
                      <option <?= (isset($q24->specialized_trafficking_victims_quality_q24) && $q24->specialized_trafficking_victims_quality_q24 == $key) || (isset($q24['specialized_trafficking_victims_quality_q24']) && $q24['specialized_trafficking_victims_quality_q24'] == $key) ? 'selected' : ''; ?> value="{{ $key }}">{{ $training }}</option>
                      @endforeach
                    </select>
                  </td>
                  <td><input type="number" name="specialized_trafficking_victims_men_q24[]" class="form-control specialized_trafficking_victims_men_q24" value="{{ $q24->specialized_trafficking_victims_men_q24 ?? ($q24['specialized_trafficking_victims_men_q24'] ?? 0) }}" min="0"></td>
                  <td><input type="number" name="specialized_trafficking_victims_women_q24[]" class="form-control specialized_trafficking_victims_women_q24" value="{{ $q24->specialized_trafficking_victims_women_q24 ?? ($q24['specialized_trafficking_victims_women_q24'] ?? 0) }}" min="0"></td>
                  <td><input type="number" name="specialized_trafficking_victims_tg_q24[]" class="form-control specialized_trafficking_victims_tg_q24" value="{{ $q24->specialized_trafficking_victims_tg_q24 ?? ($q24['specialized_trafficking_victims_tg_q24'] ?? 0) }}" min="0"></td>
                  <td><input type="number" name="specialized_trafficking_victims_boy_q24[]" class="form-control specialized_trafficking_victims_boy_q24" value="{{ $q24->specialized_trafficking_victims_boy_q24 ?? ($q24['specialized_trafficking_victims_boy_q24'] ?? 0) }}" min="0"></td>
                  <td><input type="number" name="specialized_trafficking_victims_girl_q24[]" class="form-control specialized_trafficking_victims_girl_q24" value="{{ $q24->specialized_trafficking_victims_girl_q24 ?? ($q24['specialized_trafficking_victims_girl_q24'] ?? 0) }}" min="0"></td>
                  <td><input type="text" name="specialized_trafficking_victims_total_q24[]" class="form-control specialized_trafficking_victims_total_q24" readonly value="{{ $q24->specialized_trafficking_victims_total_q24 ?? ($q24['specialized_trafficking_victims_total_q24'] ?? 0) }}"></td>
                  <td>
                    <select name="specialized_trafficking_victims_location_q24[old_<?= $i ?>][]" class="form-control multiSelect" multiple="multiple">
                      @include('superadmin.case.helper.location', ['selected_locations' => $saved_locations])
                    </select>
                  </td>
                  <td>
                    <?php if ($i < 3) { ?>
                    ...
                    <?php } else { ?>
                      <button type="button" id="old_<?= $i; ?>" class="btn btn-danger btn_remove cicle">-</button>
                    <?php } ?>
                  </td>
                </tr>
                <?php $i++; ?>
              ...
              <?php } else { ?>
                ...
                <tr class="qe24NoOfRow" id="row_f1">
                  ...
                  <td>
                    <select name="specialized_trafficking_victims_location_q24[f1][]" class="form-control multiSelect" multiple="multiple">
                ...
                <tr class="qe24NoOfRow" id="row_f2">
                  ...
                  <td><input type="text" name="specialized_trafficking_victims_total_q24[]" class="form-control specialized_trafficking_victims_total_q24" value="0" readonly></td>
                  <td>
                    <select name="specialized_trafficking_victims_location_q24[f2][]" class="form-control multiSelect" multiple="multiple">
                      @include('superadmin.case.helper.location')
                    </select>
                  </td>
                  <td></td>
                ...
                <tr class="qe24NoOfRow" id="row_f3">
                  ...
                  <td><input type="text" name="specialized_trafficking_victims_total_q24[]" class="form-control specialized_trafficking_victims_total_q24" value="0" readonly></td>
                  <td>
                    <select name="specialized_trafficking_victims_location_q24[f3][]" class="form-control multiSelect" multiple="multiple">
                      @include('superadmin.case.helper.location')
                    </select>
                  </td>
                  <td></td>
                ...
                <tr class="qe24NoOfRow" id="row_f4">
                  ...
                  <td><input type="text" name="specialized_trafficking_victims_total_q24[]" class="form-control specialized_trafficking_victims_total_q24" value="0" readonly></td>
                  <td>
                    <select name="specialized_trafficking_victims_location_q24[f4][]" class="form-control multiSelect" multiple="multiple">
                      @include('superadmin.case.helper.location')
                    </select>
                  </td>
                  <td>
  ...
  <script type="text/javascript">
    $(function() {
      ...
      // ডায়নামিক নতুন রো যুক্ত করার লজিক (আপনার দেওয়া অরিজিনাল স্ক্রিপ্ট)
      ...
      // রো রিমুভ করার লজিক (আপনার দেওয়া আইডি বেইজড রিমুভ সিস্টেম)
      ...
      $(document).on('click', '#temp-save-question24', function(e) {
        ...
        $('.qe24NoOfRow').each(function() {
            let protection = $(this).find("select[name='specialized_trafficking_victims_protection_q24[]']").val();
            let quality = $(this).find("select[name='specialized_trafficking_victims_quality_q24[]']").val();
            ...
            // আইডি এক্সট্রাক্ট করা (old_0, f1, বা timestamp ইউনিক আইডি)
            ...
            courtData.push({
                ...
                row_identifier: rowId // ব্যাকএন্ডে ইউনিক লোকেশন ট্র্যাক করার জন্য
            });
        });
