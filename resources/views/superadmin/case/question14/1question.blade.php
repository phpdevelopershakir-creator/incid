  ...
  <div id="Question-1" class="collapse" role="tabpanel" aria-labelledby="heading-1" data-parent="#accordion-2">
    <div class="card-body">
      ...
      <div class="icheck-primary">
        <input type="radio" id="radioOne1" class="onestatus" name="is_supreme_court_q1" value="1" {{ $q1_checked == "1" ? "checked" : "" }}>
        <label for="radioOne1">Yes</label>
      </div>
      <div class="icheck-primary">
        <input type="radio" id="radioOne2" class="onestatus" name="is_supreme_court_q1" value="0" {{ $q1_checked == "0" ? "checked" : "" }}>
        <label for="radioOne2">No</label>
      </div>
      <div class="icheck-primary input-group">
        <input type="radio" id="radioOne3" class="onestatus" name="is_supreme_court_q1" value="2" {{ $q1_checked == "2" ? "checked" : "" }}>
        <label for="radioOne3">Others</label>
        <span class="col-md-6 mt--4 q1_others_container {{ $q1_checked == '2' ? '' : 'othersText' }}">
          <input type="text" id="q7others" placeholder="Others" class="form-control" value="{{ $q1_others_val }}" name="others_supreme_court_q1">
        </span>
      </div>
          ...
          <tbody>
            ...
            <tr class="qe1NoOfRow" id="t1_row_{{ $index }}">
              <td>
                ...
                @else
                <input type="text" name="supreme_court_title[]" class="form-control row-title" placeholder="Others Specific" value="{{ $row['title'] ?? '' }}">
                @endif
              </td>
              <td>
            ...
            <tr class="qe1NoOfRow">
              <td><input type="text" name="supreme_court_title[]" class="form-control row-title" placeholder="Others Specific"></td>
              <td>
                <select name="supreme_court_status[]" class="form-control q10Input row-status">
                  <option value="" disabled selected>---Choose an item--</option>
                  @foreach ($training_status as $key => $status)
        ...
        <table id="addRow2Q10" class="table table-bordered text-center">
          ...
          <tbody>
            ...
            <tr class="qe1NoOfRow2" id="t2_row_{{ $index }}">
              <td><input type="text" name="supreme_court_title_two[]" class="form-control row-title-two" value="{{ $row['title_two'] ?? '' }}"></td>
              <td>
            ...
            <tr class="qe1NoOfRow2">
              ...
              <td><input type="file" name="supreme_court_image_two[]" class="form-control"></td>
              <td><button id="addRowDatas2Q10" type="button" class="btn btn-sm btn-primary">+</button></td>
            </tr>
            @endif
          </tbody>
        </table>
