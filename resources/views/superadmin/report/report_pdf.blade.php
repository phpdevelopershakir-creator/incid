...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Case Report Date Wish</h1>
        </div>
        <div class="col-sm-6">
  ...
  <section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
        <a style="margin:5px;" href="{{url('superadmin/reports/pdf')}}" target="_blank" class="btn btn-info float-right">PDF Dawnload</a>
   <!-- question no 1  Start -->
    ...
    <div class="card card-outline collapsed-card">
      ...
      <table class="table" style="border: 0;">
          ...
          <tbody>
          @foreach($questionsOne as $sex_location)
          <tr>
...
<td>
{{date('d-m-Y', strtotime($sex_location->created_at))}}
  </td>
           </tr>
      ...
      <div class="card card-outline collapsed-card">
        ...
        <div class="card-body">
          ...
          <table class="table table-white" style="border: none;">
            ...
            <tbody>
            @foreach($questionsThree as $three)
              <tr>
                <th scope="row">
                <div>
  ...
  <div class="card card-outline collapsed-card">
    ...
    <div class="card-body">
      ...
      <table id="addRowQ10" class="table table-bordered text-center">
        ...
        <tbody>
        @foreach($questionsTen as $ten)
          <tr>
            <td >
            {{$ten->trafficking_country	}}
            </td>
            <td>
      ...
      <div class="card card-outline collapsed-card">
        ...
        <div class="card-body">
          ...
          <table class="table table-white">
            ...
            <tbody>
            @foreach($questionsEleven as $eleven)
              <tr>
                <td >
      ...
      <div class="card card-outline collapsed-card">
        ...
        <div class="card-body">
          ...
          <table id="addRowQ12" class="table table-bordered text-center">
            ...
            <tbody>
            @foreach($questionsTwelve as $twelve)
              <tr>
                <td >
                {{$twelve->country_id_q12}}
                </td>
                <td> 
      ...
      <div class="card card-outline collapsed-card">
        ...
        <div class="card-body">
          <table class="table" border="2">
            ...
            <tbody>
            @foreach($questionsThirteen as $thirteen)
              <tr>
                <td>
        ...
        <div class="card-body">
         ...
         <div id="fifteen_question_view">
          <table class="table table-white">
            ...
            <tbody>
            @foreach($questionsFifteen as $fifteen)
              <tr>
                <td>
      ...
      <div class="card card-outline collapsed-card">
        ...
        <div class="card-body">
          ...
          <table class="table table-white">
            ...
            <tbody>
            @foreach($questionsSixteen as $sixteen)
              <tr>
                <td><div>
        ...
        <div class="card-body">
         ...
         <div id="seventeen_question_view">
          <table class="table table-white">
            ...
            <tbody>
            @foreach($questionsSeventeen as $seventeen)
              <tr>
                <td><div>
...
<div class="col-md-12 question19">
 <div class="card card-outline collapsed-card">
   ...
   <div class="card-body">
    ...
    @foreach($questionsNineteen as $nineteen)
         <tr>
    
         <td>   <div>   {{ $nineteen->q19_country_id }}  </div>  </td>
...
<tbody>
@foreach($questionsTwenty as $twenty)
          <tr>
            <td> 
            <div>   {{ $twenty->q20_country_id }}  </div>
            </td>
