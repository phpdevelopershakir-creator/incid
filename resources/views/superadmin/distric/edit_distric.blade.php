            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ route('superadmin.update.district',$distric->id) }}" method="post">
                    @csrf
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="exampleInputUsername1">District  Name <span style="color:red">*</span></span></label>
                          <input type="text" name="name" class="form-control form-control-sm" value="{{ old('name',$distric->name) }}" id="exampleInputUsername1"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="bn_name" class="form-control form-control-sm" value="{{ old('bn_name',$distric->bn_name) }}" id="exampleInputUsername1"
                      ...
                      <div class="col-md-12">
                       ...
                       <select class="form-control" name="division_id" required>
                        ...
                        <option value="{{ $division->id }}" @if($division->id == $distric->division_id) selected @endif>{{ $division->name }} {{$division->bn_name}}</option>
                        @endforeach
                       </select>
